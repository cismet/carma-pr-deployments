import{j as e}from"./jsx-runtime-DCY474Ph.js";import{D as s,r as l,R as p,a as x}from"./resolution-by-fov-and-range-plot-BYyUHPps.js";import{G as d,a as o}from"./mercator-zoom.shared-DWoXNaHX.js";import"./index-f9CH5uyH.js";import"./angles-B5wuhJLI.js";import"./pi-BNTPxsWB.js";import"./mercator-wo1U-jlG.js";import"./geodetic-BlUMYLim.js";import"./three.module-BMbCMmAQ.js";import"./annotation-cursor-overlay-style-BiBLE8yx.js";import"./index-BrmODtEK.js";import"./ControlButtonStyler-E6yNKOeB.js";import"./useLineSegmentVisualizers-CwDRi-Xw.js";import"./index-o4jIgCFn.js";import"./index-B4PKD6xO.js";import"./angle-normalization-D3Clryc1.js";import"./geometry2d-CI45uUTk.js";const j={title:"Geo",args:{xAxisMode:s.FOV_DEG},argTypes:{xAxisMode:{options:Object.values(s),control:{type:"inline-radio"},description:"Horizontal axis as direct FOV degrees, log(fov), or log(tan(fov / 2))."}},parameters:{layout:"fullscreen"}},t={name:"Range by FOV and Resolution",render:n=>e.jsxs(d,{label:"Range by FOV Overview",values:[l(n.xAxisMode),"compare range and resolution views"],children:[e.jsxs("section",{style:o.layout.intro,children:[e.jsx("p",{style:o.text.introText,children:"Dolly zoom trades field of view against distance to keep subject size fixed."}),e.jsx("p",{style:o.text.introText,children:"range = k / tan(fov / 2)"}),e.jsx("p",{style:o.text.introText,children:"The upper plot shows range as the output. The lower plot shows the matching center resolution instead."})]}),e.jsx("section",{style:o.layout.panel,children:e.jsx(p,{xAxisMode:n.xAxisMode})}),e.jsx("section",{style:o.layout.panel,children:e.jsx(x,{xAxisMode:n.xAxisMode})})]})};var a,r,i;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
