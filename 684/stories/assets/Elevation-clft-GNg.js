...
{
    out_FragColor = ${Vs(e)};
}`,nO=e=>new Hn({translucent:e.alpha<1,closed:!1,renderState:Mh,vertexShaderSource:KA,fragmentShaderSource:tO(e)}),oO=({id:e,geometry:t,color:n,opacity:o,materialPreset:i,modelMatrix:a,asynchronous:r=!0})=>{const s=O.fromAlpha(n,o,new O);return i===zo.COLOR?new Ue({geometryInstances:new Ya({id:`${e}-fill`,geometry:t}),appearance:nO(s),allowPicking:!1,asynchronous:r,releaseGeometryInstances:!0,show:!0,modelMatrix:a}):new Ue({geometryInstances:new Ya({id:`${e}-fill`,geometry:t}),appearance:eO(i,s),allowPicking:!1,asynchronous:r,releaseGeometryInstances:!0,show:!0,modelMatrix:a})},iO=e=>{const t=UA(e.radius),n=GA(e.innerRadius,t),o=Dh(e.segments),i=Nh(e.angleRad),a=Lh(o,i),r=kA(e.rotationRad),s=e.modelMatrix??M.IDENTITY,c=jA(e.materialPreset),l=e.color??zh,d=VA(e.opacity,l.alpha??LA),m=rO(f.ZERO,t,r);return{normalizedInnerRadius:qA(n,t),arcSampling:a,color:l,opacity:d,materialPreset:c,vertexFormat:c===zo.COLOR?Ph:BA,modelMatrix:M.multiply(s,m,new M)}},rO=(e,t=1,n=0)=>DA(e,t,n,Ih),aO=(e,t)=>{const n=iO(t),o=$A({innerRadiusRatio:n.normalizedInnerRadius,angleRad:t.angleRad,segments:n.arcSampling.segments,vertexFormat:n.vertexFormat});return oO({id:e,geometry:o,color:n.color,opacity:n.opacity,materialPreset:n.materialPreset,modelMatrix:n.modelMatrix,asynchronous:t.asynchronous})},sO=(e,t)=>aO(e,{...t,angleRad:kn,rotationRad:0}),vO=(e,t)=>sO(e,{...t,innerRadius:0});Gh("[CESIUM|ELEVATION] Using core elevation helpers from @carma-mapping/engines/cesium/core.");export{wO as $,Oe as A,Q as B,A as C,T as D,Vf as E,ue as F,Ya as G,ns as H,Xe as I,Mt as J,wA as K,yO as L,M,_O as N,Ee as O,Ue as P,K as Q,le as R,gO as S,_e as T,AO as U,OO as V,zo as W,kh as X,bO as Y,id as Z,EO as _,f as a,Rl as a$,TO as a0,os as a1,qe as a2,xO as a3,ye as a4,Ar as a5,Ae as a6,oe as a7,De as a8,Se as a9,Ls as aA,At as aB,nn as aC,ht as aD,Kt as aE,en as aF,tt as aG,Me as aH,Pt as aI,Hn as aJ,Be as aK,mt as aL,FE as aM,Us as aN,Jt as aO,ln as aP,So as aQ,St as aR,L1 as aS,F1 as aT,ii as aU,Qa as aV,gi as aW,It as aX,Ot as aY,z as aZ,ge as a_,Re as aa,zn as ab,Ai as ac,J as ad,Ce as ae,ro as af,oo as ag,dn as ah,Et as ai,Lt as aj,to as ak,Te as al,Tt as am,xe as an,Ge as ao,zt as ap,Oi as aq,Ve as ar,Bo as as,ni as at,Fe as au,re as av,nt as aw,ss as ax,Ma as ay,me as az,ne as b,he as b0,pn as b1,Le as b2,Ye as b3,Mo as b4,Ze as b5,Vt as b6,eo as b7,An as b8,dt as b9,so as ba,In as bb,jt as bc,jf as bd,wt as be,Cn as bf,we as bg,cu as bh,Qf as bi,li as bj,rc as bk,ui as bl,vr as bm,mn as bn,st as bo,wo as bp,Gt as bq,jh as br,SO as bs,CO as bt,O as c,vO as d,sO as e,aO as f,$A as g,DA as h,u as i,U as j,on as k,qh as l,X as m,Sn as n,P as o,j as p,Ti as q,h as r,et as s,qo as t,We as u,ee as v,yr as w,dm as x,ae as y,pO as z};
