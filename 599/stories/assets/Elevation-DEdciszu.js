...
`,v2=`vec3 lambertianDiffuse(vec3 diffuseColor)
{
...
`,T2=`// KhronosGroup https://github.com/KhronosGroup/ToneMapping/tree/main/PBR_Neutral
...
`,S2=`float czm_private_getLambertDiffuseOfMaterial(vec3 lightDirectionEC, czm_material material)
{
...
`,P2=`float czm_reverseLogDepth(float logZ)
{
#ifdef LOG_DEPTH
...
`,H2=`vec2 getLookupUv(vec2 dimensions, int i) {
...
`,K2=`vec4 czm_screenToEyeCoordinates(vec4 screenCoordinate)
{
...
`,vc={czm_degreesPerRadian:xv,czm_depthRange:Ov,czm_epsilon1:Cv,czm_epsilon2:Mv,czm_epsilon3:Rv,czm_epsilon4:Pv,czm_epsilon5:Iv,czm_epsilon6:zv,czm_epsilon7:Nv,czm_infinity:Dv,czm_oneOverPi:Lv,czm_oneOverTwoPi:Fv,czm_passCesium3DTile:Bv,czm_passCesium3DTileClassification:Uv,czm_passCesium3DTileClassificationIgnoreShow:Gv,czm_passClassification:qv,czm_passCompute:kv,czm_passEnvironment:jv,czm_passGaussianSplats:Vv,czm_passGlobe:Hv,czm_passOpaque:Wv,czm_passOverlay:Yv,czm_passTerrainClassification:$v,czm_passTranslucent:Xv,czm_passVoxels:Zv,czm_pi:Kv,czm_piOverFour:Qv,czm_piOverSix:Jv,czm_piOverThree:eT,czm_piOverTwo:tT,czm_radiansPerDegree:nT,czm_sceneMode2D:oT,czm_sceneMode3D:iT,czm_sceneModeColumbusView:rT,czm_sceneModeMorphing:aT,czm_solarRadius:sT,czm_threePiOver2:cT,czm_twoPi:fT,czm_webMercatorMaxLatitude:hT,czm_depthRangeStruct:lT,czm_material:uT,czm_materialInput:dT,czm_modelMaterial:mT,czm_modelVertexOutput:pT,czm_ray:_T,czm_raySegment:gT,czm_shadowParameters:yT,czm_HSBToRGB:bT,czm_HSLToRGB:ET,czm_RGBToHSB:wT,czm_RGBToHSL:vT,czm_RGBToXYZ:TT,czm_XYZToRGB:ST,czm_acesTonemapping:AT,czm_alphaWeight:xT,czm_antialias:OT,czm_applyHSBShift:CT,czm_approximateSphericalCoordinates:MT,czm_approximateTanh:RT,czm_backFacing:PT,czm_branchFreeTernary:IT,czm_cascadeColor:zT,czm_cascadeDistance:NT,czm_cascadeMatrix:DT,czm_cascadeWeights:LT,czm_clipPolygons:FT,czm_columbusViewMorph:BT,czm_computeAtmosphereColor:UT,czm_computeGroundAtmosphereScattering:GT,czm_computePosition:qT,czm_computeScattering:kT,czm_cosineAndSine:jT,czm_decompressTextureCoordinates:VT,czm_depthClamp:HT,czm_eastNorthUpToEyeCoordinates:WT,czm_ellipsoidContainsPoint:YT,czm_ellipsoidTextureCoordinates:$T,czm_equalsEpsilon:XT,czm_eyeOffset:ZT,czm_eyeToWindowCoordinates:KT,czm_fastApproximateAtan:QT,czm_fog:JT,czm_gammaCorrect:e2,czm_geodeticSurfaceNormal:t2,czm_getDefaultMaterial:n2,czm_getDynamicAtmosphereLightDirection:o2,czm_getLambertDiffuse:i2,czm_getSpecular:r2,czm_getWaterNoise:a2,czm_hue:s2,czm_inverseGamma:c2,czm_isEmpty:f2,czm_isFull:h2,czm_latitudeToWebMercatorFraction:l2,czm_lineDistance:u2,czm_linearToSrgb:d2,czm_luminance:m2,czm_maximumComponent:p2,czm_metersPerPixel:_2,czm_modelToWindowCoordinates:g2,czm_multiplyWithColorBalance:y2,czm_nearFarScalar:b2,czm_octDecode:E2,czm_packDepth:w2,czm_pbrLighting:v2,czm_pbrNeutralTonemapping:T2,czm_phong:S2,czm_planeDistance:A2,czm_pointAlongRay:x2,czm_rayEllipsoidIntersectionInterval:O2,czm_raySphereIntersectionInterval:C2,czm_readDepth:M2,czm_readNonPerspective:R2,czm_reverseLogDepth:P2,czm_round:I2,czm_saturation:z2,czm_shadowDepthCompare:N2,czm_shadowVisibility:D2,czm_signNotZero:L2,czm_sphericalHarmonics:F2,czm_srgbToLinear:B2,czm_tangentToEyeSpaceMatrix:U2,czm_textureCube:G2,czm_transformPlane:q2,czm_translateRelativeToEye:k2,czm_translucentPhong:j2,czm_transpose:V2,czm_unpackClippingExtents:H2,czm_unpackDepth:W2,czm_unpackFloat:Y2,czm_unpackUint:$2,czm_valueTransform:X2,czm_vertexLogDepth:Z2,czm_windowToEyeCoordinates:K2,czm_writeDepthClamp:Q2,czm_writeLogDepth:J2,czm_writeNonPerspective:eS};function tS(e,t){let n=e;return n=n.replaceAll("version 300 es",""),n=n.replaceAll(/(texture\()/g,"texture2D("),t?(n=n.replaceAll(/\n\s*(in)\s+(vec\d|mat\d|float)/g,`
...
`;return o})}function im(e,t,n){let o;for(let i=0;i<n.length;++i)n[i].name===e&&(o=n[i]);return l(o)||(t=om(t),o={name:e,glslSource:t,dependsOn:[],requiredBy:[],evaluated:!1},n.push(o)),o}function rm(e,t){if(e.evaluated)return;e.evaluated=!0;let n=e.glslSource.match(/\bczm_[a-zA-Z0-9_]*/g);l(n)&&n!==null&&(n=n.filter(function(o,i){return n.indexOf(o)===i}),n.forEach(function(o){if(o!==e.name&&it._czmBuiltinsAndUniforms.hasOwnProperty(o)){const i=im(o,it._czmBuiltinsAndUniforms[o],t);e.dependsOn.push(i),i.requiredBy.push(e),rm(i,t)}}))}function nS(e){const t=[],n=[];for(;e.length>0;){const i=e.pop();n.push(i),i.requiredBy.length===0&&t.push(i)}for(;t.length>0;){const i=t.shift();e.push(i);for(let r=0;r<i.dependsOn.length;++r){const a=i.dependsOn[r],s=a.requiredBy.indexOf(i);a.requiredBy.splice(s,1),a.requiredBy.length===0&&t.push(a)}}const o=[];for(let i=0;i<n.length;++i)n[i].requiredBy.length!==0&&o.push(n[i]);if(o.length!==0){let i=`A circular dependency was found in the following built-in functions/structs/constants: 
`;for(let r=0;r<o.length;++r)i=`${i+o[r].name}
`;throw new w(i)}}function oS(e){const t=[],n=im("main",e,t);rm(n,t),nS(t);let o="";for(let i=t.length-1;i>=0;--i)o=`${o+t[i].glslSource}
`;return o.replace(n.glslSource,"")}function am(e,t,n){let o,i,r="";const a=e.sources;if(l(a))for(o=0,i=a.length;o<i;++o)r+=`
#line 0
...
`);let _="";e.includeBuiltIns&&(_=oS(r)),d+=`
#line 0
...
`);return`${t}:${n}:${o}:${i}`};it.prototype.createCombinedVertexShader=function(e){return am(this,!1,e)};it.prototype.createCombinedFragmentShader=function(e){return am(this,!0,e)};it._czmBuiltinsAndUniforms={};for(const e in vc)vc.hasOwnProperty(e)&&(it._czmBuiltinsAndUniforms[e]=vc[e]);for(const e in ka)if(ka.hasOwnProperty(e)){const t=ka[e];typeof t.getDeclaration=="function"&&(it._czmBuiltinsAndUniforms[e]=t.getDeclaration(e))}it.createPickVertexShaderSource=function(e){return`${it.replaceMain(e,"czm_old_main")}
in vec4 pickColor; 
...
`,zS=`// Thanks for the contribution Jonas
...
`;function ee(e){this.type=void 0,this.shaderSource=void 0,this.materials=void 0,this.uniforms=void 0,this._uniforms=void 0,this.translucent=void 0,this._minificationFilter=e.minificationFilter??Ft.LINEAR,this._magnificationFilter=e.magnificationFilter??oi.LINEAR,this._strict=void 0,this._template=void 0,this._count=void 0,this._texturePaths={},this._loadedImages=[],this._loadedCubeMaps=[],this._textures={},this._updateFunctions=[],this._defaultTexture=void 0,this._initializationPromises=[],this._initializationError=void 0,NS(e,this),Object.defineProperties(this,{type:{value:this.type,writable:!1},minificationFilter:{get:function(){return this._minificationFilter},set:function(t){this._minificationFilter=t}},magnificationFilter:{get:function(){return this._magnificationFilter},set:function(t){this._magnificationFilter=t}}}),l(ee._uniformList[this.type])||(ee._uniformList[this.type]=Object.keys(this._uniforms))}ee._uniformList={};ee.fromType=function(e,t){if(!l(ee._materialCache.getMaterial(e)))throw new w(`material with type '${e}' does not exist.`);const n=new ee({fabric:{type:e}});if(l(t))for(const o in t)t.hasOwnProperty(o)&&(n.uniforms[o]=t[o]);return n};ee.fromTypeAsync=async function(e,t){if(!l(ee._materialCache.getMaterial(e)))throw new w(`material with type '${e}' does not exist.`);const n=[],o=new ee({fabric:{type:e,uniforms:t}});if(dm(o,n),await Promise.all(n),n.length=0,l(o._initializationError))throw o._initializationError;return o};function dm(e,t){t.push(...e._initializationPromises);const n=e.materials;for(const o in n)if(n.hasOwnProperty(o)){const i=n[o];dm(i,t)}}ee.prototype.isTranslucent=function(){if(l(this.translucent))return typeof this.translucent=="function"?this.translucent():this.translucent;let e=!0;const t=this._translucentFunctions,n=t.length;for(let o=0;o<n;++o){const i=t[o];if(typeof i=="function"?e=e&&i():e=e&&i,!e)break}return e};ee.prototype.update=function(e){this._defaultTexture=e.defaultTexture;let t,n;const o=this._loadedImages;let i=o.length;for(t=0;t<i;++t){const c=o[t];n=c.id;let f=c.image,d;Array.isArray(f)&&(d=f.slice(1,f.length).map(function(y){return y.bufferView}),f=f[0]);const u=new eo({minificationFilter:this._minificationFilter,magnificationFilter:this._magnificationFilter});let m;l(f.internalFormat)?m=new Kt({context:e,pixelFormat:f.internalFormat,width:f.width,height:f.height,source:{arrayBufferView:f.bufferView,mipLevels:d},sampler:u}):m=new Kt({context:e,source:f,sampler:u});const _=this._textures[n];l(_)&&_!==this._defaultTexture&&_.destroy(),this._textures[n]=m;const g=`${n}Dimensions`;if(this.uniforms.hasOwnProperty(g)){const y=this.uniforms[g];y.x=m._width,y.y=m._height}}o.length=0;const r=this._loadedCubeMaps;for(i=r.length,t=0;t<i;++t){const c=r[t];n=c.id;const f=c.images,d=new Je({context:e,source:{positiveX:f[0],negativeX:f[1],positiveY:f[2],negativeY:f[3],positiveZ:f[4],negativeZ:f[5]},sampler:new eo({minificationFilter:this._minificationFilter,magnificationFilter:this._magnificationFilter})});this._textures[n]=d}r.length=0;const a=this._updateFunctions;for(i=a.length,t=0;t<i;++t)a[t](this,e);const s=this.materials;for(const c in s)s.hasOwnProperty(c)&&s[c].update(e)};ee.prototype.isDestroyed=function(){return!1};ee.prototype.destroy=function(){const e=this._textures;for(const n in e)if(e.hasOwnProperty(n)){const o=e[n];o!==this._defaultTexture&&o.destroy()}const t=this.materials;for(const n in t)t.hasOwnProperty(n)&&t[n].destroy();return Lt(this)};function NS(e,t){e=e??xe.EMPTY_OBJECT,t._strict=e.strict??!1,t._count=e.count??0,t._template=en(e.fabric??xe.EMPTY_OBJECT),t.fabric=en(e.fabric??xe.EMPTY_OBJECT),t._template.uniforms=en(t._template.uniforms??xe.EMPTY_OBJECT),t._template.materials=en(t._template.materials??xe.EMPTY_OBJECT),t.type=l(t._template.type)?t._template.type:Xf(),t.shaderSource="",t.materials={},t.uniforms={},t._uniforms={},t._translucentFunctions=[];let n;const o=ee._materialCache.getMaterial(t.type);if(l(o)){const r=en(o.fabric,!0);t._template=nn(t._template,r,!0),n=o.translucent}BS(t),GS(t),VS(t),WS(t),l(o)||ee._materialCache.addMaterial(t.type,t);const i=t._translucentFunctions.length===0?!0:void 0;if(n=n??i,n=e.translucent??n,l(n))if(typeof n=="function"){const r=function(){return n(t)};t._translucentFunctions.push(r)}else t._translucentFunctions.push(n)}function Tc(e,t,n,o){if(l(e)){for(const i in e)if(e.hasOwnProperty(i)){const r=t.indexOf(i)!==-1;(o&&!r||!o&&r)&&n(i,t)}}}function ru(e,t){let n=`fabric: property name '${e}' is not valid. It should be `;for(let o=0;o<t.length;o++){const i=`'${t[o]}'`;n+=o===t.length-1?`or ${i}.`:`${i}, `}throw new w(n)}function DS(e,t){const n=`fabric: uniforms and materials cannot share the same property '${e}'`;throw new w(n)}const LS=["type","materials","uniforms","components","source"],FS=["diffuse","specular","shininess","normal","emission","alpha"];function BS(e){const t=e._template,n=t.uniforms,o=t.materials,i=t.components;if(l(i)&&l(t.source))throw new w("fabric: cannot have source and components in the same template.");Tc(t,LS,ru,!0),Tc(i,FS,ru,!0);const r=[];for(const a in o)o.hasOwnProperty(a)&&r.push(a);Tc(n,r,DS,!1)}function US(e,t){const n=t._template.materials;for(const o in n)if(n.hasOwnProperty(o)&&e.indexOf(o)>-1)return!0;return!1}function GS(e){const t=e._template.components,n=e._template.source;if(l(n))e.shaderSource+=`${n}
`;else{if(e.shaderSource+=`czm_material czm_getMaterial(czm_materialInput materialInput)
{
`,e.shaderSource+=`czm_material material = czm_getDefaultMaterial(materialInput);
`,l(t)){const o=Object.keys(e._template.materials).length>0;for(const i in t)if(t.hasOwnProperty(i))if(i==="diffuse"||i==="emission"){const a=o&&US(t[i],e)?t[i]:`czm_gammaCorrect(${t[i]})`;e.shaderSource+=`material.${i} = ${a}; 
`}else i==="alpha"?e.shaderSource+=`material.alpha = ${t.alpha}; 
`:e.shaderSource+=`material.${i} = ${t[i]};
`}e.shaderSource+=`return material;
}
`}}const au={mat2:ge,mat3:B,mat4:q},qS=/\.ktx2$/i;function kS(e){let t;return function(n,o){const i=n.uniforms,r=i[e],a=t!==r,s=!l(r)||r===ee.DefaultImageId;t=r;let c=n._textures[e],f,d;if(r instanceof HTMLVideoElement){if(r.readyState>=2){if(a&&l(c)&&(c!==o.defaultTexture&&c.destroy(),c=void 0),!l(c)||c===o.defaultTexture){const u=new eo({minificationFilter:n._minificationFilter,magnificationFilter:n._magnificationFilter});c=new Kt({context:o,source:r,sampler:u}),n._textures[e]=c;return}c.copyFrom({source:r})}else l(c)||(n._textures[e]=o.defaultTexture);return}if(r instanceof Kt&&r!==c){n._texturePaths[e]=void 0;const u=n._textures[e];l(u)&&u!==n._defaultTexture&&u.destroy(),n._textures[e]=r,f=`${e}Dimensions`,i.hasOwnProperty(f)&&(d=i[f],d.x=r._width,d.y=r._height);return}if(a&&l(c)&&s&&(c!==n._defaultTexture&&c.destroy(),c=void 0,n._texturePaths[e]=void 0),l(c)||(c=n._textures[e]=n._defaultTexture,f=`${e}Dimensions`,i.hasOwnProperty(f)&&(d=i[f],d.x=c._width,d.y=c._height)),!s){if((r instanceof HTMLCanvasElement||r instanceof HTMLImageElement||r instanceof ImageBitmap||r instanceof OffscreenCanvas)&&r!==n._texturePaths[e]){n._loadedImages.push({id:e,image:r}),n._texturePaths[e]=r;return}mm(n,e)}}}function mm(e,t){const o=e.uniforms[t];if(o===ee.DefaultImageId)return Promise.resolve();const i=se.createIfNeeded(o);if(!(i instanceof se))return Promise.resolve();const r=se.createIfNeeded(e._texturePaths[t]);if(!(!l(r)||r.url!==i.url))return Promise.resolve();let s;return qS.test(i.url)?s=_d(i.url):s=i.fetchImage(),Promise.resolve(s).then(function(c){e._loadedImages.push({id:t,image:c})}).catch(function(c){e._initializationError=c;const f=e._textures[t];l(f)&&f!==e._defaultTexture&&f.destroy(),e._textures[t]=e._defaultTexture}),e._texturePaths[t]=o,s}function jS(e){return function(t,n){const o=t.uniforms[e];if(o instanceof Je){const i=t._textures[e];i!==t._defaultTexture&&i.destroy(),t._texturePaths[e]=void 0,t._textures[e]=o;return}l(t._textures[e])||(t._textures[e]=n.defaultCubeMap),pm(t,e)}}function pm(e,t){const o=e.uniforms[t];if(o===ee.DefaultCubeMapId)return Promise.resolve();const i=o.positiveX+o.negativeX+o.positiveY+o.negativeY+o.positiveZ+o.negativeZ;if(i===e._texturePaths[t])return Promise.resolve();const r=[se.createIfNeeded(o.positiveX).fetchImage(),se.createIfNeeded(o.negativeX).fetchImage(),se.createIfNeeded(o.positiveY).fetchImage(),se.createIfNeeded(o.negativeY).fetchImage(),se.createIfNeeded(o.positiveZ).fetchImage(),se.createIfNeeded(o.negativeZ).fetchImage()],a=Promise.all(r);return a.then(function(s){e._loadedCubeMaps.push({id:t,images:s})}).catch(function(s){e._initializationError=s}),e._texturePaths[t]=i,a}function VS(e){const t=e._template.uniforms;for(const n in t)t.hasOwnProperty(n)&&_m(e,n)}function _m(e,t){const n=e._strict,o=e._template.uniforms,i=o[t],r=HS(i);if(!l(r))throw new w(`fabric: uniform '${t}' has invalid type.`);let a;if(r==="channels"){if(a=Fr(e,t,i,!1),a===0&&n)throw new w(`strict: shader source does not use channels '${t}'.`)}else{if(r==="sampler2D"){const f=`${t}Dimensions`;YS(e,f)>0&&(o[f]={type:"ivec3",x:1,y:1},_m(e,f))}if(!new RegExp(`uniform\\s+${r}\\s+${t}\\s*;`).test(e.shaderSource)){const f=`uniform ${r} ${t};`;e.shaderSource=f+e.shaderSource}const c=`${t}_${e._count++}`;if(a=Fr(e,t,c),a===1&&n)throw new w(`strict: shader source does not use uniform '${t}'.`);if(e.uniforms[t]=i,r==="sampler2D")e._uniforms[c]=function(){return e._textures[t]},e._updateFunctions.push(kS(t)),e._initializationPromises.push(mm(e,t));else if(r==="samplerCube")e._uniforms[c]=function(){return e._textures[t]},e._updateFunctions.push(jS(t)),e._initializationPromises.push(pm(e,t));else if(r.indexOf("mat")!==-1){const f=new au[r];e._uniforms[c]=function(){return au[r].fromColumnMajorArray(e.uniforms[t],f)}}else e._uniforms[c]=function(){return e.uniforms[t]}}}function HS(e){let t=e.type;if(!l(t)){const n=typeof e;if(n==="number")t="float";else if(n==="boolean")t="bool";else if(n==="string"||e instanceof se||e instanceof HTMLCanvasElement||e instanceof HTMLImageElement||e instanceof ImageBitmap||e instanceof OffscreenCanvas)/^([rgba]){1,4}$/i.test(e)?t="channels":e===ee.DefaultCubeMapId?t="samplerCube":t="sampler2D";else if(n==="object")if(Array.isArray(e))(e.length===4||e.length===9||e.length===16)&&(t=`mat${Math.sqrt(e.length)}`);else{let o=0;for(const i in e)e.hasOwnProperty(i)&&(o+=1);o>=2&&o<=4?t=`vec${o}`:o===6&&(t="samplerCube")}}return t}function WS(e){const t=e._strict,n=e._template.materials;for(const o in n)if(n.hasOwnProperty(o)){const i=new ee({strict:t,fabric:n[o],count:e._count});e._count=i._count,e._uniforms=nn(e._uniforms,i._uniforms,!0),e.materials[o]=i,e._translucentFunctions=e._translucentFunctions.concat(i._translucentFunctions);const r="czm_getMaterial",a=`${r}_${e._count++}`;Fr(i,r,a),e.shaderSource=i.shaderSource+e.shaderSource;const s=`${a}(materialInput)`;if(Fr(e,o,s)===0&&t)throw new w(`strict: shader source does not use material '${o}'.`)}}function Fr(e,t,n,o){o=o??!0;let i=0;const r="([\\w])?",a=`([\\w${o?".":""}])?`,s=new RegExp(a+t+r,"g");return e.shaderSource=e.shaderSource.replace(s,function(c,f,d){return f||d?c:(i+=1,n)}),i}function YS(e,t,n){return Fr(e,t,t,n)}ee._materialCache={_materials:{},addMaterial:function(e,t){this._materials[e]=t},getMaterial:function(e){return this._materials[e]}};ee.DefaultImageId="czm_defaultImage";ee.DefaultCubeMapId="czm_defaultCubeMap";ee.ColorType="Color";ee._materialCache.addMaterial(ee.ColorType,{fabric:{type:ee.ColorType,uniforms:{color:new x(1,0,0,.5)},components:{diffuse:"color.rgb",alpha:"color.a"}},translucent:function(e){return e.uniforms.color.alpha<1}});ee.ImageType="Image";ee._materialCache.addMaterial(ee.ImageType,{fabric:{type:ee.ImageType,uniforms:{image:ee.DefaultImageId,repeat:new V(1,1),color:new x(1,1,1,1)},components:{diffuse:"texture(image, fract(repeat * materialInput.st)).rgb * color.rgb",alpha:"texture(image, fract(repeat * materialInput.st)).a * color.a"}},translucent:function(e){return e.uniforms.color.alpha<1}});ee.DiffuseMapType="DiffuseMap";ee._materialCache.addMaterial(ee.DiffuseMapType,{fabric:{type:ee.DiffuseMapType,uniforms:{image:ee.DefaultImageId,channels:"rgb",repeat:new V(1,1)},components:{diffuse:"texture(image, fract(repeat * materialInput.st)).channels"}},translucent:!1});ee.AlphaMapType="AlphaMap";ee._materialCache.addMaterial(ee.AlphaMapType,{fabric:{type:ee.AlphaMapType,uniforms:{image:ee.DefaultImageId,channel:"a",repeat:new V(1,1)},components:{alpha:"texture(image, fract(repeat * materialInput.st)).channel"}},translucent:!0});ee.SpecularMapType="SpecularMap";ee._materialCache.addMaterial(ee.SpecularMapType,{fabric:{type:ee.SpecularMapType,uniforms:{image:ee.DefaultImageId,channel:"r",repeat:new V(1,1)},components:{specular:"texture(image, fract(repeat * materialInput.st)).channel"}},translucent:!1});ee.EmissionMapType="EmissionMap";ee._materialCache.addMaterial(ee.EmissionMapType,{fabric:{type:ee.EmissionMapType,uniforms:{image:ee.DefaultImageId,channels:"rgb",repeat:new V(1,1)},components:{emission:"texture(image, fract(repeat * materialInput.st)).channels"}},translucent:!1});ee.BumpMapType="BumpMap";ee._materialCache.addMaterial(ee.BumpMapType,{fabric:{type:ee.BumpMapType,uniforms:{image:ee.DefaultImageId,channel:"r",strength:.8,repeat:new V(1,1)},source:_S},translucent:!1});ee.NormalMapType="NormalMap";ee._materialCache.addMaterial(ee.NormalMapType,{fabric:{type:ee.NormalMapType,uniforms:{image:ee.DefaultImageId,channels:"rgb",strength:.8,repeat:new V(1,1)},source:SS},translucent:!1});ee.GridType="Grid";ee._materialCache.addMaterial(ee.GridType,{fabric:{type:ee.GridType,uniforms:{color:new x(0,1,0,1),cellAlpha:.1,lineCount:new V(8,8),lineThickness:new V(1,1),lineOffset:new V(0,0)},source:TS},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.cellAlpha<1}});ee.StripeType="Stripe";ee._materialCache.addMaterial(ee.StripeType,{fabric:{type:ee.StripeType,uniforms:{horizontal:!0,evenColor:new x(1,1,1,.5),oddColor:new x(0,0,1,.5),offset:0,repeat:5},source:PS},translucent:function(e){const t=e.uniforms;return t.evenColor.alpha<1||t.oddColor.alpha<1}});ee.CheckerboardType="Checkerboard";ee._materialCache.addMaterial(ee.CheckerboardType,{fabric:{type:ee.CheckerboardType,uniforms:{lightColor:new x(1,1,1,.5),darkColor:new x(0,0,0,.5),repeat:new V(5,5)},source:gS},translucent:function(e){const t=e.uniforms;return t.lightColor.alpha<1||t.darkColor.alpha<1}});ee.DotType="Dot";ee._materialCache.addMaterial(ee.DotType,{fabric:{type:ee.DotType,uniforms:{lightColor:new x(1,1,0,.75),darkColor:new x(0,1,1,.75),repeat:new V(5,5)},source:yS},translucent:function(e){const t=e.uniforms;return t.lightColor.alpha<1||t.darkColor.alpha<1}});ee.WaterType="Water";ee._materialCache.addMaterial(ee.WaterType,{fabric:{type:ee.WaterType,uniforms:{baseWaterColor:new x(.2,.3,.6,1),blendColor:new x(0,1,.699,1),specularMap:ee.DefaultImageId,normalMap:ee.DefaultImageId,frequency:10,animationSpeed:.01,amplitude:1,specularIntensity:.5,fadeFactor:1},source:zS},translucent:function(e){const t=e.uniforms;return t.baseWaterColor.alpha<1||t.blendColor.alpha<1}});ee.RimLightingType="RimLighting";ee._materialCache.addMaterial(ee.RimLightingType,{fabric:{type:ee.RimLightingType,uniforms:{color:new x(1,0,0,.7),rimColor:new x(1,1,1,.4),width:.3},source:MS},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.rimColor.alpha<1}});ee.FadeType="Fade";ee._materialCache.addMaterial(ee.FadeType,{fabric:{type:ee.FadeType,uniforms:{fadeInColor:new x(1,0,0,1),fadeOutColor:new x(0,0,0,0),maximumDistance:.5,repeat:!0,fadeDirection:{x:!0,y:!0},time:new V(.5,.5)},source:vS},translucent:function(e){const t=e.uniforms;return t.fadeInColor.alpha<1||t.fadeOutColor.alpha<1}});ee.PolylineArrowType="PolylineArrow";ee._materialCache.addMaterial(ee.PolylineArrowType,{fabric:{type:ee.PolylineArrowType,uniforms:{color:new x(1,1,1,1)},source:AS},translucent:!0});ee.PolylineDashType="PolylineDash";ee._materialCache.addMaterial(ee.PolylineDashType,{fabric:{type:ee.PolylineDashType,uniforms:{color:new x(1,0,1,1),gapColor:new x(0,0,0,0),dashLength:16,dashPattern:255},source:xS},translucent:!0});ee.PolylineGlowType="PolylineGlow";ee._materialCache.addMaterial(ee.PolylineGlowType,{fabric:{type:ee.PolylineGlowType,uniforms:{color:new x(0,.5,1,1),glowPower:.25,taperPower:1},source:OS},translucent:!0});ee.PolylineOutlineType="PolylineOutline";ee._materialCache.addMaterial(ee.PolylineOutlineType,{fabric:{type:ee.PolylineOutlineType,uniforms:{color:new x(1,1,1,1),outlineColor:new x(1,0,0,1),outlineWidth:1},source:CS},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.outlineColor.alpha<1}});ee.ElevationContourType="ElevationContour";ee._materialCache.addMaterial(ee.ElevationContourType,{fabric:{type:ee.ElevationContourType,uniforms:{spacing:100,color:new x(1,0,0,1),width:1},source:ES},translucent:!1});ee.ElevationRampType="ElevationRamp";ee._materialCache.addMaterial(ee.ElevationRampType,{fabric:{type:ee.ElevationRampType,uniforms:{image:ee.DefaultImageId,minimumHeight:0,maximumHeight:1e4},source:wS},translucent:!1});ee.SlopeRampMaterialType="SlopeRamp";ee._materialCache.addMaterial(ee.SlopeRampMaterialType,{fabric:{type:ee.SlopeRampMaterialType,uniforms:{image:ee.DefaultImageId},source:RS},translucent:!1});ee.AspectRampMaterialType="AspectRamp";ee._materialCache.addMaterial(ee.AspectRampMaterialType,{fabric:{type:ee.AspectRampMaterialType,uniforms:{image:ee.DefaultImageId},source:pS},translucent:!1});ee.ElevationBandType="ElevationBand";ee._materialCache.addMaterial(ee.ElevationBandType,{fabric:{type:ee.ElevationBandType,uniforms:{heights:ee.DefaultImageId,colors:ee.DefaultImageId},source:bS},translucent:!0});ee.WaterMaskType="WaterMask";ee._materialCache.addMaterial(ee.WaterMaskType,{fabric:{type:ee.WaterMaskType,source:IS,uniforms:{waterColor:new x(1,1,1,1),landColor:new x(0,0,0,0)}},translucent:!1});const $S={NEVER:I.NEVER,LESS:I.LESS,EQUAL:I.EQUAL,LESS_OR_EQUAL:I.LEQUAL,GREATER:I.GREATER,NOT_EQUAL:I.NOTEQUAL,GREATER_OR_EQUAL:I.GEQUAL,ALWAYS:I.ALWAYS},XS=Object.freeze($S);function no(e,t,n){if(!l(e))throw new w("context is required");if(!l(t))throw new w("attributes is required");if(!l(n))throw new w("numberOfInstances is required");if(this._attributes=t,this._numberOfInstances=n,t.length===0)return;const o=ZS(t),i=e.floatingPointTexture,r=o===Oe.FLOAT&&!i,a=KS(t,r),s=QS(a,t,r),c=Math.floor(Pe.maximumTextureSize/s),f=Math.min(n,c),d=s*f,u=Math.ceil(n/f),m=1/d,_=m*.5,g=1/u,y=g*.5;this._textureDimensions=new V(d,u),this._textureStep=new Q(m,_,g,y),this._pixelDatatype=r?Oe.UNSIGNED_BYTE:o,this._packFloats=r,this._offsets=a,this._stride=s,this._texture=void 0;const E=4*d*u;this._batchValues=o===Oe.FLOAT&&!r?new Float32Array(E):new Uint8Array(E),this._batchValuesDirty=!1}Object.defineProperties(no.prototype,{attributes:{get:function(){return this._attributes}},numberOfInstances:{get:function(){return this._numberOfInstances}}});function ZS(e){let t=!1;const n=e.length;for(let o=0;o<n;++o)if(e[o].componentDatatype!==ue.UNSIGNED_BYTE){t=!0;break}return t?Oe.FLOAT:Oe.UNSIGNED_BYTE}function gm(e,t){const n=e[t].componentsPerAttribute;return n===2?V:n===3?h:n===4?Q:Number}function KS(e,t){const n=new Array(e.length);let o=0;const i=e.length;for(let r=0;r<i;++r){const s=e[r].componentDatatype;n[r]=o,s!==ue.UNSIGNED_BYTE&&t?o+=4:++o}return n}function QS(e,t,n){const o=e.length,i=e[o-1];return t[o-1].componentDatatype!==ue.UNSIGNED_BYTE&&n?i+4:i+1}const pr=new Q;function JS(e,t,n){let o=Q.unpack(e,t,pr);const i=Q.unpackFloat(o);o=Q.unpack(e,t+4,pr);const r=Q.unpackFloat(o);o=Q.unpack(e,t+8,pr);const a=Q.unpackFloat(o);o=Q.unpack(e,t+12,pr);const s=Q.unpackFloat(o);return Q.fromElements(i,r,a,s,n)}function eA(e,t,n){let o=Q.packFloat(e.x,pr);Q.pack(o,t,n),o=Q.packFloat(e.y,o),Q.pack(o,t,n+4),o=Q.packFloat(e.z,o),Q.pack(o,t,n+8),o=Q.packFloat(e.w,o),Q.pack(o,t,n+12)}const su=new Q;no.prototype.getBatchedAttribute=function(e,t,n){if(e<0||e>=this._numberOfInstances)throw new w("instanceIndex is out of range.");if(t<0||t>=this._attributes.length)throw new w("attributeIndex is out of range");const o=this._attributes,i=this._offsets[t],a=4*this._stride*e+4*i;let s;this._packFloats&&o[t].componentDatatype!==Oe.UNSIGNED_BYTE?s=JS(this._batchValues,a,su):s=Q.unpack(this._batchValues,a,su);const c=gm(o,t);return l(c.fromCartesian4)?c.fromCartesian4(s,n):l(c.clone)?c.clone(s,n):s.x};const tA=[void 0,void 0,new V,new h,new Q],nA=new Q;no.prototype.setBatchedAttribute=function(e,t,n){if(e<0||e>=this._numberOfInstances)throw new w("instanceIndex is out of range.");if(t<0||t>=this._attributes.length)throw new w("attributeIndex is out of range");if(!l(n))throw new w("value is required.");const o=this._attributes,i=tA[o[t].componentsPerAttribute],r=this.getBatchedAttribute(e,t,i),a=gm(this._attributes,t);if(l(a.equals)?a.equals(r,n):r===n)return;const c=nA;c.x=l(n.x)?n.x:n,c.y=l(n.y)?n.y:0,c.z=l(n.z)?n.z:0,c.w=l(n.w)?n.w:0;const f=this._offsets[t],u=4*this._stride*e+4*f;this._packFloats&&o[t].componentDatatype!==Oe.UNSIGNED_BYTE?eA(c,this._batchValues,u):Q.pack(c,this._batchValues,u),this._batchValuesDirty=!0};function oA(e,t){const n=e._textureDimensions;e._texture=new Kt({context:t,pixelFormat:Me.RGBA,pixelDatatype:e._pixelDatatype,width:n.x,height:n.y,sampler:eo.NEAREST,flipY:!1})}function iA(e){const t=e._textureDimensions;e._texture.copyFrom({source:{width:t.x,height:t.y,arrayBufferView:e._batchValues}})}no.prototype.update=function(e){l(this._texture)&&!this._batchValuesDirty||this._attributes.length===0||(this._batchValuesDirty=!1,l(this._texture)||oA(this,e.context),iA(this))};no.prototype.getUniformMapCallback=function(){const e=this;return function(t){return e._attributes.length===0?t:nn(t,{batchTexture:function(){return e._texture},batchTextureDimensions:function(){return e._textureDimensions},batchTextureStep:function(){return e._textureStep}})}};function rA(e){const t=e._stride;return e._textureDimensions.y===1?`uniform vec4 batchTextureStep; 
...
`}function aA(e){return e===1?"float":`vec${e}`}function sA(e){return e===1?".x":e===2?".xy":e===3?".xyz":""}function cA(e,t){const o=e._attributes[t],i=o.componentsPerAttribute,r=o.functionName,a=aA(i),s=sA(i),c=e._offsets[t];let f=`${a} ${r}(float batchId) 
{ 
...
`)}function OA(e){let t=it.replaceMain(e,"czm_non_depth_clamp_main");return t+=`void main() {
    czm_non_depth_clamp_main();
    gl_Position = czm_depthClamp(gl_Position);}
`,t}function CA(e){let t=it.replaceMain(e,"czm_non_depth_clamp_main");return t+=`void main() {
    czm_non_depth_clamp_main();
    #if defined(LOG_DEPTH)
        czm_writeLogDepth();
    #else
...
void main()
{
    vec4 p = czm_computePosition();
    gl_Position = czm_modelViewProjectionRelativeToEye * p;
}`,Ba=e=>Number.isFinite(e)?e.toFixed(6):"0.0",dh=e=>`vec4(${Ba(e.red)}, ${Ba(e.green)}, ${Ba(e.blue)}, ${Ba(e.alpha)})`,r4=e=>`
in vec2 v_st;
...
}`,s4=(e,t)=>new Go({translucent:!0,closed:!1,renderState:lp,vertexShaderSource:o4,fragmentShaderSource:e===Ni.CHROME_MIRROR?r4(t):a4(t)}),c4=e=>`
void main()
{
    out_FragColor = ${dh(e)};
}`,f4=e=>new Go({translucent:e.alpha<1,closed:!1,renderState:lp,vertexShaderSource:i4,fragmentShaderSource:c4(e)}),h4=({id:e,geometry:t,color:n,opacity:o,materialPreset:i,modelMatrix:r})=>{const a=x.fromAlpha(n,o,new x);return i===Ni.COLOR?new rt({geometryInstances:new Kc({id:`${e}-fill`,geometry:t}),appearance:f4(a),allowPicking:!1,asynchronous:!0,releaseGeometryInstances:!0,show:!0,modelMatrix:r}):new rt({geometryInstances:new Kc({id:`${e}-fill`,geometry:t}),appearance:s4(i,a),allowPicking:!1,asynchronous:!0,releaseGeometryInstances:!0,show:!0,modelMatrix:r})},l4=e=>{const t=WR(e.radius),n=YR(e.innerRadius,t),o=dp(e.segments),i=up(e.angleRad),r=mp(o,i),a=XR(e.rotationRad),s=e.modelMatrix??q.IDENTITY,c=KR(e.materialPreset),f=e.color??cp,d=ZR(e.opacity,f.alpha??jR),u=u4(h.ZERO,t,a);return{normalizedInnerRadius:$R(n,t),arcSampling:r,color:f,opacity:d,materialPreset:c,vertexFormat:c===Ni.COLOR?hp:HR,modelMatrix:q.multiply(s,u,new q)}},u4=(e,t=1,n=0)=>kR(e,t,n,fp),d4=(e,t)=>{const n=l4(t),o=n4({innerRadiusRatio:n.normalizedInnerRadius,angleRad:t.angleRad,segments:n.arcSampling.segments,vertexFormat:n.vertexFormat});return h4({id:e,geometry:o,color:n.color,opacity:n.opacity,materialPreset:n.materialPreset,modelMatrix:n.modelMatrix})},m4=(e,t)=>d4(e,{...t,angleRad:Do,rotationRad:0}),D4=(e,t)=>m4(e,{...t,innerRadius:0});th("[CESIUM|ELEVATION] Using core elevation helpers from @carma-mapping/engines/cesium/core.");export{cf as $,Ee as A,ie as B,h as C,w as D,Ku as E,xe as F,Kc as G,sf as H,gt as I,Ge as J,un as K,yR as L,q as M,S4 as N,Be as O,rt as P,oe as Q,Se as R,O4 as S,Ie as T,C4 as U,o_ as V,A4 as W,__ as X,P4 as Y,R4 as Z,M4 as _,x as a,en as a$,th as a0,st as a1,z4 as a2,I4 as a3,co as a4,N4 as a5,Ni as a6,ze as a7,ss as a8,Ue as a9,Ef as aA,Fc as aB,Me as aC,Xf as aD,Kt as aE,qn as aF,Lt as aG,Nn as aH,Un as aI,At as aJ,Je as aK,ln as aL,Go as aM,it as aN,Ut as aO,XS as aP,Qf as aQ,Bn as aR,$n as aS,Si as aT,nn as aU,$A as aV,XA as aW,mr as aX,nf as aY,Lr as aZ,hn as a_,ue as aa,tt as ab,qe as ac,We as ad,bo as ae,Wr as af,ae as ag,je as ah,ti as ai,Jo as aj,Qn as ak,Zt as al,pn as am,Ko as an,De as ao,$t as ap,ke as aq,at as ar,cn as as,Yr as at,ft as au,ki as av,ur as aw,ot as ax,ge as ay,xt as az,m4 as b,I as b0,Pe as b1,F0 as b2,Oe as b3,eo as b4,nt as b5,_t as b6,Fi as b7,bt as b8,An as b9,Zo as ba,lo as bb,Ft as bc,oi as bd,Eo as be,xn as bf,Qu as bg,Xt as bh,_o as bi,Fe as bj,_d as bk,a0 as bl,Mr as bm,$h as bn,Rr as bo,us as bp,Jn as bq,Rt as br,bi as bs,wn as bt,r_ as bu,T4 as bv,Cr as bw,Na as bx,D4 as c,d4 as d,n4 as e,kR as f,T as g,V as h,l as i,le as j,kn as k,n_ as l,ee as m,mo as n,B as o,Q as p,jr as q,x4 as r,p as s,St as t,Wi as u,mt as v,v4 as w,se as x,ns as y,Ag as z};
