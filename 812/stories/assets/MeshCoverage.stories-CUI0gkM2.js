import{m as re}from"./mesh2024-cesium-parity.style-B2CBcfqi.js";import{j as t}from"./jsx-runtime-DNp_qQjF.js";import{r as i}from"./index-CSJjS6Ct.js";import{a as ge}from"./maplibre-gl-BvLDYGIs.js";import{m as Fe}from"./StripChartPanel-QdhqwE7N.js";import{F as Y,ao as Ge,h as Ve,S as _e,r as Ie,m as Ne,l as Ue}from"./index-DvOUGBsN.js";import{a as Re,b as He}from"./raster-dem-terrain-runtime-BZBiI5Q0.js";import"./ObjectCentricViewStateInfoBox-B9milZXK.js";/* empty css                    */import"./angles-o81lIhgd.js";import"./index-M0u9yaJ4.js";import"./pitch-conventions-csFBkMEs.js";import"./gazData-Cz3QgY8a.js";import"./wms-uhWQECSC.js";import"./ViewStateNavigationManagerContext-HKhsWxGe.js";import"./AnnotationsProvider-Cx82BE-E.js";import"./custom-shaders-Bm5AsYJb.js";import"./ControlButtonStyler-C_yTvQxK.js";import"./gcg2016-RydMRdXg.js";/* empty css                                      */import"./useLineSegmentVisualizers-xvGPzDMM.js";import"./useCesiumFovWheelZoom-B4t1EToH.js";import{c as $e}from"./maplibre-story-style-IbzX9XsM.js";import{W as Je,b as Ye,T as Ke,a as Ze}from"./TileLoadingDebug-TZ2HIEva.js";import{r as Xe}from"./index-D1cknlJ6.js";import{dR as Qe,dS as et,V as K,dG as tt,dL as nt,P as rt,dT as at}from"./three.module-BsINTyXW.js";import{p as ot,D as it}from"./TileLoadingDebugPanels-B8BIqBQO.js";import{N as st}from"./terrain-CDUojVZ_.js";import{a as lt,l as dt,c as ut}from"./raster-dem-terrain-tile-source-gnuY1_Gd.js";import{T as be,a as fe}from"./terrain-no-data-QpUXwA_M.js";import{c as ct}from"./shared-three-scene-camera-preview-DJQ5MblO.js";import"./gltf1-upgrade-plugin-BnIraZfg.js";import{B as _}from"./button--E3d1eE9.js";import{S as oe}from"./index-9kLXGxEM.js";import{R as pt}from"./index-CA5isoQy.js";import{S as mt}from"./index-ClW0EZG2.js";import"./iframe-DXfmEPgy.js";import"./___vite-browser-external_commonjs-proxy-N_IygbFj.js";import"./geo-B1nqeUzv.js";import"./zoom-BADcZy_j.js";import"./scene-accumulator-BSDum8k6.js";import"./scene-accumulation-format-pMkB0RMu.js";import"./clamp-co6UzHBn.js";import"./plugins-DiPIaVd3-BUs4OHma.js";import"./DRACOLoader-B-rO9Syu.js";import"./hostname-hE_TUoNR.js";import"./plugins-BN2uUf5f-B-a5kHaQ.js";import"./tiles-camera-set-DInj6eja.js";import"./derived-cache-epoch-B1SlmyVB.js";import"./index-6T-cIyLx.js";import"./index-BmoRKiMu.js";import"./context-ByJTMbV5.js";import"./pi-mVFkAveX.js";import"./FrameWait-DQacRE39.js";import"./carma-guards-CPuGuSqL.js";import"./Scene-y3gMHgvp.js";import"./meshopt_encoder.module-D2BiFfpM.js";import"./meshopt_decoder.module-Clo9gF-m.js";import"./sampleTerrainMostDetailed-DrnNkf6p.js";import"./negative-pi-to-pi-B-FiLZ9M.js";import"./Picking-CTmYY7TD.js";import"./KeyCode-DzcwBGA9.js";import"./useCSSVarCls-BR1NoMov.js";import"./create-view-state-visualizer-BLGvBn0Z.js";import"./camera-intrinsics-utils-tHu2xf2P.js";import"./angle-normalization-DjAbKHgp.js";import"./derivations-BUhj3CB6.js";import"./plane-intersections-DhJfyQJx.js";import"./constants-C6-_E4xW.js";import"./geometry2d-Hnn8LWlg.js";import"./Line2-DHoRMF2J.js";import"./LineSegments2-k4_0rUZU.js";import"./LineGeometry-CzSN4Jlh.js";import"./mesh-helpers-D335rxiI.js";import"./index-DzECKETA.js";import"./BaseInput-yXMpEdQI.js";import"./TextArea-DZUGccyX.js";import"./CheckOutlined-DcuzhUSR.js";import"./index-Cl0vUQao.js";import"./index-CjdjAb2u.js";import"./PlusOutlined-RgqIkq_r.js";import"./config-DAlQCezX.js";import"./length-format-BQI28fDZ.js";import"./decimal-format-B9rCT_ZY.js";import"./locales-DbHdB30_.js";import"./formatSignificantNumber-DYV3PWeu.js";import"./Intrinsics-62iqE0zP.js";import"./private-shims-5e5gEO17.js";import"./CesiumWidget-8hHN__dK.js";import"./svgProjection-CK1IeL40.js";import"./useLineVisualizers-G1xf-PWC.js";import"./index-B5l9eJJN.js";const ie=["left","top","right","bottom"],ht=({width:n,height:e,sizes:s,enabled:m,gap:a=16,minimumViewport:g=32})=>{if(![n,e,a,g,...Object.values(s)].every(l=>Number.isFinite(l)&&l>=0))throw new RangeError("Viewport panel dimensions must be finite and non-negative");const o={left:0,top:0,right:0,bottom:0},h={...o};for(const l of ie){const c=Math.max(0,((l==="left"||l==="right"?n:e)-g)/2);o[l]=Math.min(s[l],Math.max(0,c-a*2)),h[l]=m[l]?Math.min(c,o[l]+a*2):0}return{extents:o,padding:h}},ke=(n,e)=>{if(!(e.duration>0)||e.curve.points.length<2)throw new Error("A camera flight needs a positive duration and two points");const s=new Qe(n),m=s.clipAction(e.clip);m.setLoop(et,1),m.clampWhenFinished=!0,m.play();const a=new K,g=new K;let o,h;const l=e.clip.tracks.some(p=>p.name.endsWith(".quaternion"));return{sample(p,c){const y=(p%(e.duration*2)+e.duration*2)%(e.duration*2),r=(1-Math.cos(y*Math.PI/e.duration))/2;m.paused=!1,s.setTime(r*e.duration),e.curve.getPointAt(r,n.position),l||(e.target?n.lookAt(e.target):(e.curve.getTangentAt(r,a),n.lookAt(g.copy(n.position).add(a)))),c!==void 0&&(n.fov=c),n.fov=Math.min(120,Math.max(5,n.fov)),n.updateProjectionMatrix(),n.updateMatrixWorld(!0)},sampleAhead(p,c,y){if(!Number.isFinite(p)||!Number.isFinite(c)||c<0)throw new Error("Camera flight sample times must be finite and aheadMs must be non-negative");return o||(o=n.clone(),h=ke(o,e)),o.copy(n,!1),o.fov=n.fov,o.aspect=n.aspect,o.near=n.near,o.far=n.far,o.up.copy(n.up),o.zoom=n.zoom,o.filmGauge=n.filmGauge,o.filmOffset=n.filmOffset,o.view=n.view?{...n.view}:null,h.sample(p+c/1e3,y),o},dispose(){s.stopAllAction(),s.uncacheRoot(n),h==null||h.dispose(),o=void 0,h=void 0}}},gt=(n,e)=>new tt("camera-lens",n,[new nt(".fov",e.map((s,m)=>m*n/Math.max(1,e.length-1)),[...e])]),bt=async(n,e,s)=>{const m=await lt(n,{maxCacheBytes:16777216,meshSegments:16});try{const a=[];for(const[g,o]of e){s.throwIfAborted();const h=Math.max(n.minzoom,Math.min(13,n.maxzoom)),l={level:h,x:Math.floor(dt(g,h)),y:Math.floor(ut(o,h))};if(!m.getTileDataAvailable(l))throw new Error("Flight path lies outside the elevation source");await m.requestTile(l,s,5);const p=m.sampleHeight(g,o);if(p===void 0||!Number.isFinite(p))throw new Error("Flight path has missing elevation data");a.push(p)}return a}finally{m.release()}},ft=`{
  "version": 8,
  "metadata": {
    "carmaConf": {
      "layerInfo": {
...
`,R=16,ve="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",Se=({map:n})=>{const[e,s]=i.useState({left:!0,top:!1,right:!1,bottom:!1}),[m,a]=i.useState({left:288,right:288,top:160,bottom:160}),[g,o]=i.useState({width:0,height:0}),h=i.useRef(0),l=i.useRef(null);i.useEffect(()=>{const r=n.getContainer(),d=()=>o({width:r.clientWidth,height:r.clientHeight}),w=new ResizeObserver(d);return w.observe(r),d(),()=>{w.disconnect(),cancelAnimationFrame(h.current)}},[n]);const{extents:p,padding:c}=ht({...g,sizes:m,enabled:e,gap:R}),y=r=>p[r];return i.useEffect(()=>{!g.width||!g.height||n.setPadding(c)},[n,g.width,g.height,c.left,c.right,c.top,c.bottom]),i.useEffect(()=>()=>{n.getCanvas().isConnected&&n.setPadding({left:0,right:0,top:0,bottom:0})},[n]),t.jsxs(t.Fragment,{children:[t.jsxs("nav",{"aria-label":"Padding panels",style:{position:"absolute",left:"50%",bottom:R,transform:"translateX(-50%)",zIndex:5,display:"flex",gap:4,padding:6,borderRadius:10,background:"rgba(255,255,255,.9)",boxShadow:"0 1px 8px #0003"},children:[ie.map(r=>t.jsx("button",{"data-test-id":`padding-toggle-${r}`,"aria-pressed":e[r],onClick:()=>s(d=>({...d,[r]:!d[r]})),style:{cursor:"pointer",border:"1px solid #9aa7b3",borderRadius:6,padding:"5px 10px",background:e[r]?"#164e63":"#fff",color:e[r]?"#fff":"#172b3a",textTransform:"capitalize"},children:r},r)),t.jsx("button",{onClick:()=>s({left:!1,top:!1,right:!1,bottom:!1}),children:"Off"})]}),ie.filter(r=>e[r]).map(r=>{const d=r==="left"||r==="right",w={left:"right",right:"left",top:"bottom",bottom:"top"}[r],P=d?{[r]:R,top:c.top+R,bottom:c.bottom+R,width:y(r)}:{[r]:R,left:R,right:R,height:y(r)};return t.jsxs("aside",{"data-test-id":`padding-panel-${r}`,style:{...P,boxSizing:"border-box",position:"absolute",zIndex:3,padding:20,borderRadius:16,background:"rgba(248,250,252,.78)",color:"#172b3a",boxShadow:"0 2px 12px #0003",font:"14px/1.6 system-ui"},children:[t.jsxs("div",{style:{height:"100%",overflow:"hidden"},children:[t.jsxs("strong",{style:{textTransform:"capitalize"},children:[r," sidebar"]}),t.jsx("p",{children:ve}),t.jsx("p",{children:ve}),t.jsxs("small",{children:["Drag the inner edge · MapLibre padding:"," ",Math.round(c[r])," px"]})]}),t.jsx("div",{role:"separator",tabIndex:0,"aria-label":`Resize ${r} sidebar`,"aria-orientation":d?"vertical":"horizontal","aria-valuenow":Math.round(y(r)),"data-test-id":`padding-resize-${r}`,style:{position:"absolute",[w]:-4,...d?{top:14,bottom:14,width:10}:{left:14,right:14,height:10},cursor:d?"ew-resize":"ns-resize",touchAction:"none",borderRadius:6,background:"rgba(22,78,99,.3)"},onPointerDown:b=>{b.preventDefault(),b.currentTarget.setPointerCapture(b.pointerId),l.current={side:r,coordinate:d?b.clientX:b.clientY,size:y(r)}},onPointerMove:b=>{const T=l.current;if(!T||T.side!==r)return;const q=((d?b.clientX:b.clientY)-T.coordinate)*(r==="right"||r==="bottom"?-1:1),L=Math.max(48,T.size+q);cancelAnimationFrame(h.current),h.current=requestAnimationFrame(()=>a(O=>({...O,[r]:L})))},onPointerUp:b=>{l.current=null,b.currentTarget.releasePointerCapture(b.pointerId)},onLostPointerCapture:()=>{l.current=null},onKeyDown:b=>{if(!["ArrowLeft","ArrowRight","ArrowUp","ArrowDown"].includes(b.key))return;b.preventDefault();const T=b.key==="ArrowRight"||b.key==="ArrowDown"?1:-1;a(q=>({...q,[r]:Math.max(48,y(r)+16*T*(r==="right"||r==="bottom"?-1:1))}))}})]},r)})]})};Se.__docgenInfo={description:"UI occlusion goes only through MapLibre; no direct loader/camera updates.",methods:[],displayName:"ViewportPaddingPanels",props:{map:{required:!0,tsType:{name:"MapLibreMap"},description:""}}};const vt=({map:n,runtime:e,id:s,onClose:m,dockRequest:a})=>{const g=i.useRef(null),o=i.useRef(null),h=i.useRef(null),[l]=i.useState(()=>document.createElement("div")),p=i.useRef(null),[c,y]=i.useState(!1),[r,d]=i.useState(!1),[w,P]=i.useState({x:Math.min(16+s%3*355,Math.max(16,n.getContainer().clientWidth-356)),y:100+s%3*24}),[b,T]=i.useState("Waiting for loaded mesh"),[q,L]=i.useState(s%3===0?"schwebebahn":s%3===1?"wupper":"local"),[O,De]=i.useState(60),[Z,se]=i.useState(!0),[D,le]=i.useState(!0),I=i.useRef({width:340,height:220,fov:O,autoLens:Z,playing:D});Object.assign(I.current,{fov:O,autoLens:Z,playing:D});const de=()=>{var f;const u=p.current;p.current=null,(f=h.current)==null||f.append(l),y(!1),u&&!u.closed&&u.close()},ze=()=>{if(p.current){de();return}const u=window.open("","_blank","popup,width=640,height=420");if(!u){T("Popup blocked — allow this site's popup to undock."),d(!0);return}p.current=u,u.document.title=`Tile manager · Camera ${s+1}`,Object.assign(u.document.body.style,{margin:"0",overflow:"hidden",height:"100vh"}),u.document.body.append(l),u.addEventListener("pagehide",()=>{var f;p.current===u&&(p.current=null,(f=h.current)==null||f.append(l),y(!1))},{once:!0}),y(!0)};i.useEffect(()=>{a>0&&de()},[a]),i.useEffect(()=>{var u;return Object.assign(l.style,{width:"100%",height:"100%"}),(u=h.current)==null||u.append(l),()=>{const f=p.current;p.current=null,f==null||f.close(),l.remove()}},[l]),i.useEffect(()=>{const u=o.current;if(!u)return;const f=()=>{var E;const k=u.clientWidth,A=u.clientHeight;if(k<=0||A<=0)return;const F=Math.min(((E=u.ownerDocument.defaultView)==null?void 0:E.devicePixelRatio)??1,2,2048/Math.max(k,A));I.current.width=Math.max(1,Math.round(k*F)),I.current.height=Math.max(1,Math.round(A*F))},W=new ResizeObserver(f);W.observe(u),f();const C=u.ownerDocument.defaultView;return C==null||C.addEventListener("resize",f),()=>{W.disconnect(),C==null||C.removeEventListener("resize",f)}},[c]);const z=i.useRef(null);i.useEffect(()=>{const u=g.current;if(!u)return;const f=Re(n),W=ct(f.layer),C=new rt(60,340/220,1,12e3),k=`coverage-window-${s}`,A=n.getCenter(),F=new AbortController;let E,X=0,Q=null,ee=0,te=window,ne=!1,ue=-1/0,B=null,G=!1;(async()=>{const v=q==="local"?null:Je[q],N=(v==null?void 0:v.coordinates)??[[A.lng,A.lat]];T("Preparing bounded DGM flight profile…");const x=await bt(st,N,F.signal);if(G)return;const M=N.map((S,We)=>{const he=f.layer.projectLngLatToScene([S[0],S[1]],x[We]+((v==null?void 0:v.aboveGround)??100));if(!he)throw new Error("Shared scene has no geographic frame yet");return he}),pe=M[0].clone();if(!v){M.length=0;for(let S=0;S<8;S++)M.push(pe.clone().add(new K(Math.cos(S*Math.PI/4)*120,0,Math.sin(S*Math.PI/4)*120)))}const U=Ye,Be=q==="wupper"?f.layer.projectLngLatToScene([U.longitude,U.latitude],(U.footHeight+U.topHeight)/2)??void 0:q==="local"?pe.clone().add(new K(0,-80,0)):void 0,me=(v==null?void 0:v.duration)??90;E=ke(C,{curve:new at(M,!v,"centripetal"),duration:me,target:Be,clip:gt(me,(v==null?void 0:v.fov)??[60,45,60])}),T((v==null?void 0:v.note)??"Local orbit · DGM + 100 m"),n.triggerRepaint()})().catch(v=>{G||T(String(v))});const ce=()=>{if(G)return;te=u.ownerDocument.defaultView??window,ee=te.requestAnimationFrame(ce);const v=performance.now(),N=Q===null?0:Math.max(0,Math.min((v-Q)/1e3,.1));if(Q=v,!E||f.layer.isRenderingPaused())return;const x=I.current;x.playing&&(X+=N),!ne&&(C.aspect=x.width/x.height,E.sample(X,x.autoLens?void 0:x.fov),f.layer.setTileCameraView({id:k,camera:C,viewport:[x.width,x.height],errorTargetPixels:4,role:be.RECEIVER,priority:fe.SECONDARY}),x.playing&&v-ue>=100?(ue=v,B=f.layer.requestTileCameraAhead(M=>({id:`${k}:ahead`,camera:E.sampleAhead(X,M,x.autoLens?void 0:x.fov),viewport:[x.width,x.height],errorTargetPixels:4,role:be.RECEIVER,priority:fe.SECONDARY}),500)):!x.playing&&B&&(f.layer.removePrefetchCameraView(B),B=null),n.triggerRepaint(),ne=!0,W.present(C,u,x.width,x.height).catch(M=>{G||T(String(M))}).finally(()=>{ne=!1}))};return ee=requestAnimationFrame(ce),()=>{G=!0,F.abort(),E==null||E.dispose(),te.cancelAnimationFrame(ee),f.layer.removeTileCameraView(k),B&&f.layer.removePrefetchCameraView(B),W.dispose(),f.release(),n.triggerRepaint()}},[n,e,s,q]);const Ae=t.jsxs(_e,{container:l.ownerDocument.head,children:[t.jsx("style",{children:ot}),t.jsxs("section",{className:"tile-debug-panel","data-test-id":`coverage-camera-window-${s}`,style:{background:"transparent",width:"100%",height:"100%",display:"flex",flexDirection:"column",overflow:"hidden"},children:[t.jsxs("header",{style:{background:"rgb(248 250 252 / 96%)",display:"flex",justifyContent:"space-between",padding:"0 4px 0 8px",alignItems:"center",flexShrink:0,height:30,cursor:c?"default":"move",touchAction:"none"},onPointerDown:u=>{c||u.target.closest("button")||(z.current={x:u.clientX-w.x,y:u.clientY-w.y},u.currentTarget.setPointerCapture(u.pointerId))},onPointerMove:u=>{z.current&&P({x:Math.max(0,Math.min(n.getContainer().clientWidth-80,u.clientX-z.current.x)),y:Math.max(0,Math.min(window.innerHeight-32,u.clientY-z.current.y))})},onPointerUp:()=>{z.current=null},onPointerCancel:()=>{z.current=null},children:[t.jsxs("span",{children:["Camera ",s+1]}),t.jsxs(it,{label:`camera ${s+1}`,external:c,onToggleExternal:ze,onClose:m,children:[t.jsx(_,{type:"text","aria-label":`Camera ${s+1} options`,"aria-expanded":r,onClick:()=>d(!r),icon:t.jsx(Y,{icon:Ie})}),t.jsx(_,{type:"text","aria-label":`${D?"Pause":"Play"} camera ${s+1}`,onClick:()=>le(!D),icon:t.jsx(Y,{icon:D?Ne:Ue})})]})]}),t.jsxs("div",{ref:o,style:{position:"relative",flex:1,minHeight:0,overflow:"hidden"},children:[t.jsx("canvas",{ref:g,"data-test-id":"tile-manager-camera-preview",width:320,height:200,style:{display:"block",width:"100%",height:"100%",transform:"scaleY(-1)",background:"#18212b"}}),r&&t.jsxs("div",{"data-test-id":`camera-options-${s}`,style:{position:"absolute",top:0,right:0,bottom:0,maxWidth:"100%",boxSizing:"border-box",width:280,overflow:"auto",padding:10,background:"rgb(248 250 252 / 94%)",display:"grid",alignContent:"start",gap:8},children:[t.jsx(pt.Group,{size:"small",value:q,onChange:u=>L(u.target.value),optionType:"button",options:[{value:"schwebebahn",label:"Rail"},{value:"wupper",label:"Wupper → HKW"},{value:"local",label:"Local"}]}),t.jsxs("label",{children:[t.jsx(oe,{size:"small",checked:Z,onChange:se})," ","Animated lens ·"," ",t.jsx(oe,{size:"small",checked:D,onChange:le})," ","Fly"]}),t.jsxs("label",{children:["Vertical FOV ",O,"° (manual override)",t.jsx(mt,{"aria-label":`Camera ${s+1} FOV`,min:5,max:120,value:O,onChange:u=>{De(u),se(!1)}})]}),t.jsx("div",{children:"Resolution follows window size (up to 2048 px per side)."}),t.jsx("div",{role:"status",children:b})]})]})]})]});return t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:h,"data-test-id":`camera-dock-${s}`,style:{position:"absolute",left:w.x,top:w.y,width:340,height:250,minWidth:240,minHeight:150,maxWidth:"100%",maxHeight:"90%",resize:"both",overflow:"hidden",zIndex:8,display:c?"none":"block"}}),Xe.createPortal(Ae,l)]})},je=({map:n,runtime:e,initialCount:s=0})=>{const[m,a]=i.useState(!1),[g,o]=i.useState(0),[h,l]=i.useState(()=>[0,1,2].slice(0,s));return t.jsxs(t.Fragment,{children:[t.jsx(_,{"data-test-id":"coverage-camera-controls","aria-label":"Cameras",title:`Cameras · ${h.length}/3 active`,"aria-expanded":m,icon:t.jsx(Y,{icon:Ge}),style:{position:"absolute",top:8,right:52,zIndex:12},onClick:()=>a(!m)}),m&&t.jsxs("section",{className:"tile-debug-panel","data-test-id":"coverage-camera-control-window",style:{position:"absolute",top:46,right:52,zIndex:12,width:260,padding:10,background:"rgb(248 250 252 / 94%)"},children:[t.jsxs("header",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[t.jsxs("strong",{children:["Cameras · ",h.length,"/3"]}),t.jsx(_,{type:"text","aria-label":"Close camera controls",onClick:()=>a(!1),children:"×"})]}),["Schwebebahn","Wupper → HKW","Local orbit"].map((p,c)=>t.jsxs("label",{style:{display:"flex",gap:10,alignItems:"center",paddingBlock:8},children:[t.jsx(oe,{size:"small","aria-label":`Enable camera ${c+1}`,checked:h.includes(c),onChange:y=>l(r=>y?[...r.filter(d=>d!==c),c].sort():r.filter(d=>d!==c))}),"Camera ",c+1," · ",p]},c)),t.jsx("small",{children:"Drag a header, resize its corner, or undock. All cameras share the main scene and tile pool."}),t.jsx(_,{style:{marginTop:8},icon:t.jsx(Y,{icon:Ve}),onClick:()=>o(p=>p+1),children:"Dock all cameras"})]}),h.map(p=>t.jsx(vt,{id:p,dockRequest:g,map:n,runtime:e,onClose:()=>l(c=>c.filter(y=>y!==p))},p))]})};je.__docgenInfo={description:"Coverage story variant: all windows consume the host's existing scene and pool.",methods:[],displayName:"MeshCoverageCameraWindows",props:{map:{required:!0,tsType:{name:"MapLibreMap"},description:""},runtime:{required:!0,tsType:{name:"ThreeTilesRuntime"},description:""},initialCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}}}};const V={"parity zoom 18":{zoom:18,pitch:0,bearing:0},"zoomed in 20":{zoom:20,pitch:0,bearing:0},"overview 14":{zoom:14,pitch:0,bearing:0},"oblique 15":{zoom:15,pitch:75,bearing:20},"horizon 16":{zoom:16,pitch:85,bearing:-30}},wt=JSON.parse(ft),ae=[7.1999207,51.2725716],yt=1,j=wt.metadata.carmaConf["3d"],Le=({onOptionsChange:n,...e})=>{const s=i.useRef(e);s.current=e;const m=i.useRef(null),[a,g]=i.useState(null),[o,h]=i.useState({width:0,height:0,x:0,y:0,left:0,right:0,top:0,bottom:0}),[l,p]=i.useState(null),[c]=i.useState(()=>Fe({capacity:120,logCapacity:300}));window.__meshCoverageRecorder=c,i.useEffect(()=>{if(!m.current)return;const d=new ge.Map({container:m.current,center:ae,zoom:V[e.camera].zoom-1,pitch:V[e.camera].pitch,bearing:V[e.camera].bearing,maxPitch:85,minZoom:0,maxZoom:25,attributionControl:{},style:$e(null)});d.addControl(new ge.NavigationControl),d.setPadding({left:e.paddingLeft??0,right:e.paddingRight??0,top:e.paddingTop??0,bottom:e.paddingBottom??0});let w=null,P=null;const b=()=>{w=Re(d),P=He("mesh-2024-coverage",j.tilesetUrl,ae,{providesTerrain:!0,mapStyleDrape:"none",colorCorrection:j.colorCorrection,entry:j.entry,baseErrorTargetPixels:s.current.initialPixelError??j.baseErrorTarget,diagnostics:s.current.debug&&s.current.telemetryEnabled,cacheBudgetBytes:6*1024**3}),P.loading.setErrorTarget(s.current.idlePixelError??j.errorTarget),P.loading.setTilesetMinResolution(s.current.tilesetMinResolutionPx>0?s.current.tilesetMinResolutionPx:null),w.layer.addRuntime(P.scene),p(P),g(d)};return d.once("load",b),()=>{g(null),p(null),P&&w&&w.layer.removeRuntime(P.scene.id),w==null||w.release(),d.remove()}},[]);const y=i.useRef(!0);i.useEffect(()=>{l==null||l.loading.setErrorTarget(e.idlePixelError??j.errorTarget,e.initialPixelError??j.baseErrorTarget)},[l,e.idlePixelError,e.initialPixelError]),i.useEffect(()=>{if(!a)return;const d=V[e.camera],w={center:ae,zoom:d.zoom-1,pitch:d.pitch,bearing:d.bearing};y.current?(y.current=!1,a.jumpTo(w)):a.easeTo({...w,duration:1200})},[a,e.camera]),i.useEffect(()=>{a&&a.setVerticalFieldOfView(e.projection==="near orthographic"?yt:e.fovDegrees)},[a,e.projection,e.fovDegrees]),i.useEffect(()=>{if(!a)return;e.paddingPanels||a.setPadding({left:e.paddingLeft??0,right:e.paddingRight??0,top:e.paddingTop??0,bottom:e.paddingBottom??0});const d=()=>{if(!e.showPaddingGuide)return;const w=a.getCanvas(),P=a.project(a.getCenter()),b=a.getPadding(),T={width:w.clientWidth,height:w.clientHeight,x:Math.round(P.x*100)/100,y:Math.round(P.y*100)/100,left:b.left??0,right:b.right??0,top:b.top??0,bottom:b.bottom??0};h(q=>Object.keys(T).every(L=>q[L]===T[L])?q:T)};return d(),a.on("resize",d),a.on("move",d),()=>{a.off("resize",d),a.off("move",d)}},[a,e.paddingLeft,e.paddingRight,e.paddingTop,e.paddingBottom,e.showPaddingGuide,e.paddingPanels]),i.useEffect(()=>{if(!a||!m.current)return;const d=new ResizeObserver(()=>a.resize());return d.observe(m.current),()=>d.disconnect()},[a]);const r=o.x+110>o.width;return t.jsx("div",{className:"mesh-coverage-story",style:{height:"100vh",position:"relative",width:e.viewportWidth?`${e.viewportWidth}px`:"100%",maxWidth:"100%",marginInline:"auto"},children:t.jsxs("div",{style:{position:"absolute",inset:0},children:[t.jsx("div",{ref:m,"data-test-id":"mesh-coverage-map",style:{position:"absolute",inset:0,background:"#d8dde3"}}),e.showPaddingGuide&&t.jsxs("svg",{"data-test-id":"mesh-coverage-padding-guide",width:"100%",height:"100%",style:{position:"absolute",inset:0,pointerEvents:"none",overflow:"hidden"},"aria-label":"Usable viewport and padded map center",children:[t.jsx("rect",{x:o.left,y:o.top,width:Math.max(0,o.width-o.left-o.right),height:Math.max(0,o.height-o.top-o.bottom),fill:"none",stroke:"#00eaff",strokeWidth:"2"}),t.jsx("path",{"data-test-id":"mesh-coverage-padding-focus",d:`M${o.x-10},${o.y}h20 M${o.x},${o.y-10}v20`,fill:"none",stroke:"#00eaff",strokeWidth:"2"}),t.jsx("text",{x:o.x+(r?-14:14),y:Math.max(16,Math.min(o.height-6,o.y-8)),textAnchor:r?"end":"start",fill:"#00eaff",stroke:"#123",strokeWidth:"3",paintOrder:"stroke",style:{font:"12px sans-serif"},children:"Padded focus"})]}),a&&e.paddingPanels&&t.jsx(Se,{map:a}),a&&l&&t.jsx(je,{map:a,runtime:l,initialCount:e.cameraWindows?3:0},String(!!e.cameraWindows)),a&&l&&t.jsx(Ke,{map:a,recorder:c,options:e,runtimeHandle:l,onOptionsChange:n,open:e.debug,onOpenChange:d=>n({debug:d})})]})})},Oe=n=>{const[e,s]=i.useState({});i.useEffect(()=>{s(a=>{if(a.debug===void 0)return a;const g={...a};return delete g.debug,g})},[n.debug]);const m={...n,...e};return t.jsx(Le,{...m,onOptionsChange:a=>s(g=>({...g,...a}))})};Le.__docgenInfo={description:"",methods:[],displayName:"MeshCoverageScene",props:{showOverviewPanel:{required:!0,tsType:{name:"boolean"},description:""},showOverviewOptions:{required:!1,tsType:{name:"boolean"},description:""},showDiagnosticTools:{required:!1,tsType:{name:"boolean"},description:""},overviewUp:{required:!0,tsType:{name:"union",raw:'"tileset" | "camera-tangent"',elements:[{name:"literal",value:'"tileset"'},{name:"literal",value:'"camera-tangent"'}]},description:""},showTileGeometry:{required:!0,tsType:{name:"boolean"},description:""},showMeshStylePanel:{required:!1,tsType:{name:"boolean"},description:""},meshFillOpacity:{required:!1,tsType:{name:"number"},description:""},wireframeColor:{required:!1,tsType:{name:"string"},description:""},showOverlay:{required:!0,tsType:{name:"boolean"},description:""},hideAllDebugPanels:{required:!0,tsType:{name:"boolean"},description:""},telemetryEnabled:{required:!0,tsType:{name:"boolean"},description:""},updateOnRender:{required:!1,tsType:{name:"boolean"},description:"Capture on each scene render; coalesce while a previous capture is running."},showLegend:{required:!0,tsType:{name:"boolean"},description:""},showCharts:{required:!0,tsType:{name:"boolean"},description:""},showEventLog:{required:!0,tsType:{name:"boolean"},description:""},overviewView:{required:!0,tsType:{name:"union",raw:'"extent" | "frustum" | "free"',elements:[{name:"literal",value:'"extent"'},{name:"literal",value:'"frustum"'},{name:"literal",value:'"free"'}]},description:`Overview view: the whole extent; the frustum footprint plus a buffer,
...
}`,...(qe=(Pe=$.parameters)==null?void 0:Pe.docs)==null?void 0:qe.source}}};var Ce,Ee,Me;J.parameters={...J.parameters,docs:{...(Ce=J.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  argTypes: {
    paddingLeft: {
      control: {
        type: "range",
...
}`,...(Me=(Ee=J.parameters)==null?void 0:Ee.docs)==null?void 0:Me.source}}};const lr=["MeshCoverage","CameraWindows","ViewportPadding"];export{$ as CameraWindows,H as MeshCoverage,J as ViewportPadding,lr as __namedExportsOrder,sr as default};
