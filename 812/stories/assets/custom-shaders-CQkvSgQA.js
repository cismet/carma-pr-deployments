...
`,eT=`struct czm_shadowParameters
{
...
`,bT=`float getSignedDistance(vec2 uv, highp sampler2D clippingDistance) {
...
`,iw=`vec3 lambertianDiffuse(vec3 diffuseColor)
{
...
`,rw=`// KhronosGroup https://github.com/KhronosGroup/ToneMapping/tree/main/PBR_Neutral
...
`,aw=`float czm_private_getLambertDiffuseOfMaterial(vec3 lightDirectionEC, czm_material material)
{
...
`,uw=`float czm_readDepth(sampler2D depthTexture, vec2 texCoords)
{
...
`,dw=`float czm_reverseLogDepth(float logZ)
{
#ifdef LOG_DEPTH
...
`,Cw=`vec2 getLookupUv(vec2 dimensions, int i) {
...
`,Mw=`vec4 czm_screenToEyeCoordinates(vec4 screenCoordinate)
{
...
`,va={czm_degreesPerRadian:cb,czm_depthRange:fb,czm_epsilon1:lb,czm_epsilon2:ub,czm_epsilon3:hb,czm_epsilon4:db,czm_epsilon5:mb,czm_epsilon6:pb,czm_epsilon7:_b,czm_infinity:gb,czm_oneOverPi:yb,czm_oneOverTwoPi:bb,czm_passCesium3DTile:Tb,czm_passCesium3DTileClassification:wb,czm_passCesium3DTileClassificationIgnoreShow:Eb,czm_passClassification:Ab,czm_passCompute:Ob,czm_passEnvironment:Sb,czm_passGaussianSplats:xb,czm_passGlobe:Cb,czm_passOpaque:vb,czm_passOverlay:Rb,czm_passTerrainClassification:zb,czm_passTranslucent:Ib,czm_passVoxels:Pb,czm_pi:Mb,czm_piOverFour:Nb,czm_piOverSix:Db,czm_piOverThree:Lb,czm_piOverTwo:Fb,czm_radiansPerDegree:Bb,czm_sceneMode2D:Ub,czm_sceneMode3D:Gb,czm_sceneModeColumbusView:qb,czm_sceneModeMorphing:kb,czm_solarRadius:Vb,czm_threePiOver2:jb,czm_twoPi:Hb,czm_webMercatorMaxLatitude:Wb,czm_depthRangeStruct:Yb,czm_material:Xb,czm_materialInput:$b,czm_modelMaterial:Zb,czm_modelVertexOutput:Kb,czm_ray:Qb,czm_raySegment:Jb,czm_shadowParameters:eT,czm_HSBToRGB:tT,czm_HSLToRGB:nT,czm_RGBToHSB:oT,czm_RGBToHSL:iT,czm_RGBToXYZ:rT,czm_XYZToRGB:aT,czm_acesTonemapping:sT,czm_alphaWeight:cT,czm_antialias:fT,czm_applyHSBShift:lT,czm_approximateSphericalCoordinates:uT,czm_approximateTanh:hT,czm_backFacing:dT,czm_branchFreeTernary:mT,czm_cascadeColor:pT,czm_cascadeDistance:_T,czm_cascadeMatrix:gT,czm_cascadeWeights:yT,czm_clipPolygons:bT,czm_columbusViewMorph:TT,czm_computeAtmosphereColor:wT,czm_computeGroundAtmosphereScattering:ET,czm_computePosition:AT,czm_computeScattering:OT,czm_cosineAndSine:ST,czm_decompressTextureCoordinates:xT,czm_depthClamp:CT,czm_eastNorthUpToEyeCoordinates:vT,czm_ellipsoidContainsPoint:RT,czm_ellipsoidTextureCoordinates:zT,czm_equalsEpsilon:IT,czm_eyeOffset:PT,czm_eyeToWindowCoordinates:MT,czm_fastApproximateAtan:NT,czm_fog:DT,czm_gammaCorrect:LT,czm_geodeticSurfaceNormal:FT,czm_getDefaultMaterial:BT,czm_getDynamicAtmosphereLightDirection:UT,czm_getLambertDiffuse:GT,czm_getSpecular:qT,czm_getWaterNoise:kT,czm_hue:VT,czm_inverseGamma:jT,czm_isEmpty:HT,czm_isFull:WT,czm_latitudeToWebMercatorFraction:YT,czm_lineDistance:XT,czm_linearToSrgb:$T,czm_luminance:ZT,czm_maximumComponent:KT,czm_metersPerPixel:QT,czm_modelToWindowCoordinates:JT,czm_multiplyWithColorBalance:ew,czm_nearFarScalar:tw,czm_octDecode:nw,czm_packDepth:ow,czm_pbrLighting:iw,czm_pbrNeutralTonemapping:rw,czm_phong:aw,czm_planeDistance:sw,czm_pointAlongRay:cw,czm_rayEllipsoidIntersectionInterval:fw,czm_raySphereIntersectionInterval:lw,czm_readDepth:uw,czm_readNonPerspective:hw,czm_reverseLogDepth:dw,czm_round:mw,czm_saturation:pw,czm_shadowDepthCompare:_w,czm_shadowVisibility:gw,czm_signNotZero:yw,czm_sphericalHarmonics:bw,czm_srgbToLinear:Tw,czm_tangentToEyeSpaceMatrix:ww,czm_textureCube:Ew,czm_transformPlane:Aw,czm_translateRelativeToEye:Ow,czm_translucentPhong:Sw,czm_transpose:xw,czm_unpackClippingExtents:Cw,czm_unpackDepth:vw,czm_unpackFloat:Rw,czm_unpackUint:zw,czm_valueTransform:Iw,czm_vertexLogDepth:Pw,czm_windowToEyeCoordinates:Mw,czm_writeDepthClamp:Nw,czm_writeLogDepth:Dw,czm_writeNonPerspective:Lw};function Fw(e,t){let n=e;return n=n.replaceAll("version 300 es",""),n=n.replaceAll(/(texture\()/g,"texture2D("),t?(n=n.replaceAll(/\n\s*(in)\s+(vec\d|mat\d|float)/g,`
...
${n}`,n}function ah(e){return e=e.replace(/\/\/.*/g,""),e.replace(/\/\*\*[\s\S]*?\*\//gm,function(t){const n=t.match(/\n/gm).length;let o="";for(let i=0;i<n;++i)o+=`
`;return o})}function sh(e,t,n){let o;for(let i=0;i<n.length;++i)n[i].name===e&&(o=n[i]);return u(o)||(t=ah(t),o={name:e,glslSource:t,dependsOn:[],requiredBy:[],evaluated:!1},n.push(o)),o}function ch(e,t){if(e.evaluated)return;e.evaluated=!0;let n=e.glslSource.match(/\bczm_[a-zA-Z0-9_]*/g);u(n)&&n!==null&&(n=n.filter(function(o,i){return n.indexOf(o)===i}),n.forEach(function(o){if(o!==e.name&&Be._czmBuiltinsAndUniforms.hasOwnProperty(o)){const i=sh(o,Be._czmBuiltinsAndUniforms[o],t);e.dependsOn.push(i),i.requiredBy.push(e),ch(i,t)}}))}function Bw(e){const t=[],n=[];for(;e.length>0;){const i=e.pop();n.push(i),i.requiredBy.length===0&&t.push(i)}for(;t.length>0;){const i=t.shift();e.push(i);for(let a=0;a<i.dependsOn.length;++a){const r=i.dependsOn[a],s=r.requiredBy.indexOf(i);r.requiredBy.splice(s,1),r.requiredBy.length===0&&t.push(r)}}const o=[];for(let i=0;i<n.length;++i)n[i].requiredBy.length!==0&&o.push(n[i]);if(o.length!==0){let i=`A circular dependency was found in the following built-in functions/structs/constants: 
`;for(let a=0;a<o.length;++a)i=`${i+o[a].name}
`;throw new T(i)}}function Uw(e){const t=[],n=sh("main",e,t);ch(n,t),Bw(t);let o="";for(let i=t.length-1;i>=0;--i)o=`${o+t[i].glslSource}
`;return o.replace(n.glslSource,"")}function fh(e,t,n){let o,i,a="";const r=e.sources;if(u(r))for(o=0,i=r.length;o<i;++o)a+=`
#line 0
${r[o]}`;a=ah(a);let s;a=a.replace(/#version\s+(.*?)\n/gm,function(b,w){if(u(s)&&s!==w)throw new T(`inconsistent versions found: ${s} and ${w}`);return s=w,`
...
`);let _="";e.includeBuiltIns&&(_=Uw(a)),d+=`
#line 0
...
`,pE=`// Thanks for the contribution Jonas
...
`;function X(e){this.type=void 0,this.shaderSource=void 0,this.materials=void 0,this.uniforms=void 0,this._uniforms=void 0,this.translucent=void 0,this._minificationFilter=e.minificationFilter??dt.LINEAR,this._magnificationFilter=e.magnificationFilter??co.LINEAR,this._strict=void 0,this._template=void 0,this._count=void 0,this._texturePaths={},this._loadedImages=[],this._loadedCubeMaps=[],this._textures={},this._updateFunctions=[],this._defaultTexture=void 0,this._initializationPromises=[],this._initializationError=void 0,_E(e,this),Object.defineProperties(this,{type:{value:this.type,writable:!1},minificationFilter:{get:function(){return this._minificationFilter},set:function(t){this._minificationFilter=t}},magnificationFilter:{get:function(){return this._magnificationFilter},set:function(t){this._magnificationFilter=t}}}),u(X._uniformList[this.type])||(X._uniformList[this.type]=Object.keys(this._uniforms))}X._uniformList={};X.fromType=function(e,t){if(!u(X._materialCache.getMaterial(e)))throw new T(`material with type '${e}' does not exist.`);const n=new X({fabric:{type:e}});if(u(t))for(const o in t)t.hasOwnProperty(o)&&(n.uniforms[o]=t[o]);return n};X.fromTypeAsync=async function(e,t){if(!u(X._materialCache.getMaterial(e)))throw new T(`material with type '${e}' does not exist.`);const n=[],o=new X({fabric:{type:e,uniforms:t}});if(_h(o,n),await Promise.all(n),n.length=0,u(o._initializationError))throw o._initializationError;return o};function _h(e,t){t.push(...e._initializationPromises);const n=e.materials;for(const o in n)if(n.hasOwnProperty(o)){const i=n[o];_h(i,t)}}X.prototype.isTranslucent=function(){if(u(this.translucent))return typeof this.translucent=="function"?this.translucent():this.translucent;let e=!0;const t=this._translucentFunctions,n=t.length;for(let o=0;o<n;++o){const i=t[o];if(typeof i=="function"?e=e&&i():e=e&&i,!e)break}return e};X.prototype.update=function(e){this._defaultTexture=e.defaultTexture;let t,n;const o=this._loadedImages;let i=o.length;for(t=0;t<i;++t){const f=o[t];n=f.id;let l=f.image,d;Array.isArray(l)&&(d=l.slice(1,l.length).map(function(b){return b.bufferView}),l=l[0]);const m=new pn({minificationFilter:this._minificationFilter,magnificationFilter:this._magnificationFilter});let p;u(l.internalFormat)?p=new At({context:e,pixelFormat:l.internalFormat,width:l.width,height:l.height,source:{arrayBufferView:l.bufferView,mipLevels:d},sampler:m}):p=new At({context:e,source:l,sampler:m});const _=this._textures[n];u(_)&&_!==this._defaultTexture&&_.destroy(),this._textures[n]=p;const g=`${n}Dimensions`;if(this.uniforms.hasOwnProperty(g)){const b=this.uniforms[g];b.x=p._width,b.y=p._height}}o.length=0;const a=this._loadedCubeMaps;for(i=a.length,t=0;t<i;++t){const f=a[t];n=f.id;const l=f.images,d=new Me({context:e,source:{positiveX:l[0],negativeX:l[1],positiveY:l[2],negativeY:l[3],positiveZ:l[4],negativeZ:l[5]},sampler:new pn({minificationFilter:this._minificationFilter,magnificationFilter:this._magnificationFilter})});this._textures[n]=d}a.length=0;const r=this._updateFunctions;for(i=r.length,t=0;t<i;++t)r[t](this,e);const s=this.materials;for(const f in s)s.hasOwnProperty(f)&&s[f].update(e)};X.prototype.isDestroyed=function(){return!1};X.prototype.destroy=function(){const e=this._textures;for(const n in e)if(e.hasOwnProperty(n)){const o=e[n];o!==this._defaultTexture&&o.destroy()}const t=this.materials;for(const n in t)t.hasOwnProperty(n)&&t[n].destroy();return ht(this)};function _E(e,t){e=e??ue.EMPTY_OBJECT,t._strict=e.strict??!1,t._count=e.count??0,t._template=Ot(e.fabric??ue.EMPTY_OBJECT),t.fabric=Ot(e.fabric??ue.EMPTY_OBJECT),t._template.uniforms=Ot(t._template.uniforms??ue.EMPTY_OBJECT),t._template.materials=Ot(t._template.materials??ue.EMPTY_OBJECT),t.type=u(t._template.type)?t._template.type:ks(),t.shaderSource="",t.materials={},t.uniforms={},t._uniforms={},t._translucentFunctions=[];let n;const o=X._materialCache.getMaterial(t.type);if(u(o)){const a=Ot(o.fabric,!0);t._template=St(t._template,a,!0),n=o.translucent}TE(t),EE(t),xE(t),vE(t),u(o)||X._materialCache.addMaterial(t.type,t);const i=t._translucentFunctions.length===0?!0:void 0;if(n=n??i,n=e.translucent??n,u(n))if(typeof n=="function"){const a=function(){return n(t)};t._translucentFunctions.push(a)}else t._translucentFunctions.push(n)}function Ra(e,t,n,o){if(u(e)){for(const i in e)if(e.hasOwnProperty(i)){const a=t.indexOf(i)!==-1;(o&&!a||!o&&a)&&n(i,t)}}}function Af(e,t){let n=`fabric: property name '${e}' is not valid. It should be `;for(let o=0;o<t.length;o++){const i=`'${t[o]}'`;n+=o===t.length-1?`or ${i}.`:`${i}, `}throw new T(n)}function gE(e,t){const n=`fabric: uniforms and materials cannot share the same property '${e}'`;throw new T(n)}const yE=["type","materials","uniforms","components","source"],bE=["diffuse","specular","shininess","normal","emission","alpha"];function TE(e){const t=e._template,n=t.uniforms,o=t.materials,i=t.components;if(u(i)&&u(t.source))throw new T("fabric: cannot have source and components in the same template.");Ra(t,yE,Af,!0),Ra(i,bE,Af,!0);const a=[];for(const r in o)o.hasOwnProperty(r)&&a.push(r);Ra(n,a,gE,!1)}function wE(e,t){const n=t._template.materials;for(const o in n)if(n.hasOwnProperty(o)&&e.indexOf(o)>-1)return!0;return!1}function EE(e){const t=e._template.components,n=e._template.source;if(u(n))e.shaderSource+=`${n}
`;else{if(e.shaderSource+=`czm_material czm_getMaterial(czm_materialInput materialInput)
{
`,e.shaderSource+=`czm_material material = czm_getDefaultMaterial(materialInput);
`,u(t)){const o=Object.keys(e._template.materials).length>0;for(const i in t)if(t.hasOwnProperty(i))if(i==="diffuse"||i==="emission"){const r=o&&wE(t[i],e)?t[i]:`czm_gammaCorrect(${t[i]})`;e.shaderSource+=`material.${i} = ${r}; 
`}else i==="alpha"?e.shaderSource+=`material.alpha = ${t.alpha}; 
`:e.shaderSource+=`material.${i} = ${t[i]};
`}e.shaderSource+=`return material;
}
`}}const Of={mat2:re,mat3:P,mat4:M},AE=/\.ktx2$/i;function OE(e){let t;return function(n,o){const i=n.uniforms,a=i[e],r=t!==a,s=!u(a)||a===X.DefaultImageId;t=a;let f=n._textures[e],l,d;if(a instanceof HTMLVideoElement){if(a.readyState>=2){if(r&&u(f)&&(f!==o.defaultTexture&&f.destroy(),f=void 0),!u(f)||f===o.defaultTexture){const m=new pn({minificationFilter:n._minificationFilter,magnificationFilter:n._magnificationFilter});f=new At({context:o,source:a,sampler:m}),n._textures[e]=f;return}f.copyFrom({source:a})}else u(f)||(n._textures[e]=o.defaultTexture);return}if(a instanceof At&&a!==f){n._texturePaths[e]=void 0;const m=n._textures[e];u(m)&&m!==n._defaultTexture&&m.destroy(),n._textures[e]=a,l=`${e}Dimensions`,i.hasOwnProperty(l)&&(d=i[l],d.x=a._width,d.y=a._height);return}if(r&&u(f)&&s&&(f!==n._defaultTexture&&f.destroy(),f=void 0,n._texturePaths[e]=void 0),u(f)||(f=n._textures[e]=n._defaultTexture,l=`${e}Dimensions`,i.hasOwnProperty(l)&&(d=i[l],d.x=f._width,d.y=f._height)),!s){if((a instanceof HTMLCanvasElement||a instanceof HTMLImageElement||a instanceof ImageBitmap||a instanceof OffscreenCanvas)&&a!==n._texturePaths[e]){n._loadedImages.push({id:e,image:a}),n._texturePaths[e]=a;return}gh(n,e)}}}function gh(e,t){const o=e.uniforms[t];if(o===X.DefaultImageId)return Promise.resolve();const i=ee.createIfNeeded(o);if(!(i instanceof ee))return Promise.resolve();const a=ee.createIfNeeded(e._texturePaths[t]);if(!(!u(a)||a.url!==i.url))return Promise.resolve();let s;return AE.test(i.url)?s=bu(i.url):s=i.fetchImage(),Promise.resolve(s).then(function(f){e._loadedImages.push({id:t,image:f})}).catch(function(f){e._initializationError=f;const l=e._textures[t];u(l)&&l!==e._defaultTexture&&l.destroy(),e._textures[t]=e._defaultTexture}),e._texturePaths[t]=o,s}function SE(e){return function(t,n){const o=t.uniforms[e];if(o instanceof Me){const i=t._textures[e];i!==t._defaultTexture&&i.destroy(),t._texturePaths[e]=void 0,t._textures[e]=o;return}u(t._textures[e])||(t._textures[e]=n.defaultCubeMap),yh(t,e)}}function yh(e,t){const o=e.uniforms[t];if(o===X.DefaultCubeMapId)return Promise.resolve();const i=o.positiveX+o.negativeX+o.positiveY+o.negativeY+o.positiveZ+o.negativeZ;if(i===e._texturePaths[t])return Promise.resolve();const a=[ee.createIfNeeded(o.positiveX).fetchImage(),ee.createIfNeeded(o.negativeX).fetchImage(),ee.createIfNeeded(o.positiveY).fetchImage(),ee.createIfNeeded(o.negativeY).fetchImage(),ee.createIfNeeded(o.positiveZ).fetchImage(),ee.createIfNeeded(o.negativeZ).fetchImage()],r=Promise.all(a);return r.then(function(s){e._loadedCubeMaps.push({id:t,images:s})}).catch(function(s){e._initializationError=s}),e._texturePaths[t]=i,r}function xE(e){const t=e._template.uniforms;for(const n in t)t.hasOwnProperty(n)&&bh(e,n)}function bh(e,t){const n=e._strict,o=e._template.uniforms,i=o[t],a=CE(i);if(!u(a))throw new T(`fabric: uniform '${t}' has invalid type.`);let r;if(a==="channels"){if(r=wi(e,t,i,!1),r===0&&n)throw new T(`strict: shader source does not use channels '${t}'.`)}else{if(a==="sampler2D"){const l=`${t}Dimensions`;RE(e,l)>0&&(o[l]={type:"ivec3",x:1,y:1},bh(e,l))}if(!new RegExp(`uniform\\s+${a}\\s+${t}\\s*;`).test(e.shaderSource)){const l=`uniform ${a} ${t};`;e.shaderSource=l+e.shaderSource}const f=`${t}_${e._count++}`;if(r=wi(e,t,f),r===1&&n)throw new T(`strict: shader source does not use uniform '${t}'.`);if(e.uniforms[t]=i,a==="sampler2D")e._uniforms[f]=function(){return e._textures[t]},e._updateFunctions.push(OE(t)),e._initializationPromises.push(gh(e,t));else if(a==="samplerCube")e._uniforms[f]=function(){return e._textures[t]},e._updateFunctions.push(SE(t)),e._initializationPromises.push(yh(e,t));else if(a.indexOf("mat")!==-1){const l=new Of[a];e._uniforms[f]=function(){return Of[a].fromColumnMajorArray(e.uniforms[t],l)}}else e._uniforms[f]=function(){return e.uniforms[t]}}}function CE(e){let t=e.type;if(!u(t)){const n=typeof e;if(n==="number")t="float";else if(n==="boolean")t="bool";else if(n==="string"||e instanceof ee||e instanceof HTMLCanvasElement||e instanceof HTMLImageElement||e instanceof ImageBitmap||e instanceof OffscreenCanvas)/^([rgba]){1,4}$/i.test(e)?t="channels":e===X.DefaultCubeMapId?t="samplerCube":t="sampler2D";else if(n==="object")if(Array.isArray(e))(e.length===4||e.length===9||e.length===16)&&(t=`mat${Math.sqrt(e.length)}`);else{let o=0;for(const i in e)e.hasOwnProperty(i)&&(o+=1);o>=2&&o<=4?t=`vec${o}`:o===6&&(t="samplerCube")}}return t}function vE(e){const t=e._strict,n=e._template.materials;for(const o in n)if(n.hasOwnProperty(o)){const i=new X({strict:t,fabric:n[o],count:e._count});e._count=i._count,e._uniforms=St(e._uniforms,i._uniforms,!0),e.materials[o]=i,e._translucentFunctions=e._translucentFunctions.concat(i._translucentFunctions);const a="czm_getMaterial",r=`${a}_${e._count++}`;wi(i,a,r),e.shaderSource=i.shaderSource+e.shaderSource;const s=`${r}(materialInput)`;if(wi(e,o,s)===0&&t)throw new T(`strict: shader source does not use material '${o}'.`)}}function wi(e,t,n,o){o=o??!0;let i=0;const a="([\\w])?",r=`([\\w${o?".":""}])?`,s=new RegExp(r+t+a,"g");return e.shaderSource=e.shaderSource.replace(s,function(f,l,d){return l||d?f:(i+=1,n)}),i}function RE(e,t,n){return wi(e,t,t,n)}X._materialCache={_materials:{},addMaterial:function(e,t){this._materials[e]=t},getMaterial:function(e){return this._materials[e]}};X.DefaultImageId="czm_defaultImage";X.DefaultCubeMapId="czm_defaultCubeMap";X.ColorType="Color";X._materialCache.addMaterial(X.ColorType,{fabric:{type:X.ColorType,uniforms:{color:new O(1,0,0,.5)},components:{diffuse:"color.rgb",alpha:"color.a"}},translucent:function(e){return e.uniforms.color.alpha<1}});X.ImageType="Image";X._materialCache.addMaterial(X.ImageType,{fabric:{type:X.ImageType,uniforms:{image:X.DefaultImageId,repeat:new U(1,1),color:new O(1,1,1,1)},components:{diffuse:"texture(image, fract(repeat * materialInput.st)).rgb * color.rgb",alpha:"texture(image, fract(repeat * materialInput.st)).a * color.a"}},translucent:function(e){return e.uniforms.color.alpha<1}});X.DiffuseMapType="DiffuseMap";X._materialCache.addMaterial(X.DiffuseMapType,{fabric:{type:X.DiffuseMapType,uniforms:{image:X.DefaultImageId,channels:"rgb",repeat:new U(1,1)},components:{diffuse:"texture(image, fract(repeat * materialInput.st)).channels"}},translucent:!1});X.AlphaMapType="AlphaMap";X._materialCache.addMaterial(X.AlphaMapType,{fabric:{type:X.AlphaMapType,uniforms:{image:X.DefaultImageId,channel:"a",repeat:new U(1,1)},components:{alpha:"texture(image, fract(repeat * materialInput.st)).channel"}},translucent:!0});X.SpecularMapType="SpecularMap";X._materialCache.addMaterial(X.SpecularMapType,{fabric:{type:X.SpecularMapType,uniforms:{image:X.DefaultImageId,channel:"r",repeat:new U(1,1)},components:{specular:"texture(image, fract(repeat * materialInput.st)).channel"}},translucent:!1});X.EmissionMapType="EmissionMap";X._materialCache.addMaterial(X.EmissionMapType,{fabric:{type:X.EmissionMapType,uniforms:{image:X.DefaultImageId,channels:"rgb",repeat:new U(1,1)},components:{emission:"texture(image, fract(repeat * materialInput.st)).channels"}},translucent:!1});X.BumpMapType="BumpMap";X._materialCache.addMaterial(X.BumpMapType,{fabric:{type:X.BumpMapType,uniforms:{image:X.DefaultImageId,channel:"r",strength:.8,repeat:new U(1,1)},source:Qw},translucent:!1});X.NormalMapType="NormalMap";X._materialCache.addMaterial(X.NormalMapType,{fabric:{type:X.NormalMapType,uniforms:{image:X.DefaultImageId,channels:"rgb",strength:.8,repeat:new U(1,1)},source:aE},translucent:!1});X.GridType="Grid";X._materialCache.addMaterial(X.GridType,{fabric:{type:X.GridType,uniforms:{color:new O(0,1,0,1),cellAlpha:.1,lineCount:new U(8,8),lineThickness:new U(1,1),lineOffset:new U(0,0)},source:rE},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.cellAlpha<1}});X.StripeType="Stripe";X._materialCache.addMaterial(X.StripeType,{fabric:{type:X.StripeType,uniforms:{horizontal:!0,evenColor:new O(1,1,1,.5),oddColor:new O(0,0,1,.5),offset:0,repeat:5},source:dE},translucent:function(e){const t=e.uniforms;return t.evenColor.alpha<1||t.oddColor.alpha<1}});X.CheckerboardType="Checkerboard";X._materialCache.addMaterial(X.CheckerboardType,{fabric:{type:X.CheckerboardType,uniforms:{lightColor:new O(1,1,1,.5),darkColor:new O(0,0,0,.5),repeat:new U(5,5)},source:Jw},translucent:function(e){const t=e.uniforms;return t.lightColor.alpha<1||t.darkColor.alpha<1}});X.DotType="Dot";X._materialCache.addMaterial(X.DotType,{fabric:{type:X.DotType,uniforms:{lightColor:new O(1,1,0,.75),darkColor:new O(0,1,1,.75),repeat:new U(5,5)},source:eE},translucent:function(e){const t=e.uniforms;return t.lightColor.alpha<1||t.darkColor.alpha<1}});X.WaterType="Water";X._materialCache.addMaterial(X.WaterType,{fabric:{type:X.WaterType,uniforms:{baseWaterColor:new O(.2,.3,.6,1),blendColor:new O(0,1,.699,1),specularMap:X.DefaultImageId,normalMap:X.DefaultImageId,frequency:10,animationSpeed:.01,amplitude:1,specularIntensity:.5,fadeFactor:1},source:pE},translucent:function(e){const t=e.uniforms;return t.baseWaterColor.alpha<1||t.blendColor.alpha<1}});X.RimLightingType="RimLighting";X._materialCache.addMaterial(X.RimLightingType,{fabric:{type:X.RimLightingType,uniforms:{color:new O(1,0,0,.7),rimColor:new O(1,1,1,.4),width:.3},source:uE},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.rimColor.alpha<1}});X.FadeType="Fade";X._materialCache.addMaterial(X.FadeType,{fabric:{type:X.FadeType,uniforms:{fadeInColor:new O(1,0,0,1),fadeOutColor:new O(0,0,0,0),maximumDistance:.5,repeat:!0,fadeDirection:{x:!0,y:!0},time:new U(.5,.5)},source:iE},translucent:function(e){const t=e.uniforms;return t.fadeInColor.alpha<1||t.fadeOutColor.alpha<1}});X.PolylineArrowType="PolylineArrow";X._materialCache.addMaterial(X.PolylineArrowType,{fabric:{type:X.PolylineArrowType,uniforms:{color:new O(1,1,1,1)},source:sE},translucent:!0});X.PolylineDashType="PolylineDash";X._materialCache.addMaterial(X.PolylineDashType,{fabric:{type:X.PolylineDashType,uniforms:{color:new O(1,0,1,1),gapColor:new O(0,0,0,0),dashLength:16,dashPattern:255},source:cE},translucent:!0});X.PolylineGlowType="PolylineGlow";X._materialCache.addMaterial(X.PolylineGlowType,{fabric:{type:X.PolylineGlowType,uniforms:{color:new O(0,.5,1,1),glowPower:.25,taperPower:1},source:fE},translucent:!0});X.PolylineOutlineType="PolylineOutline";X._materialCache.addMaterial(X.PolylineOutlineType,{fabric:{type:X.PolylineOutlineType,uniforms:{color:new O(1,1,1,1),outlineColor:new O(1,0,0,1),outlineWidth:1},source:lE},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.outlineColor.alpha<1}});X.ElevationContourType="ElevationContour";X._materialCache.addMaterial(X.ElevationContourType,{fabric:{type:X.ElevationContourType,uniforms:{spacing:100,color:new O(1,0,0,1),width:1},source:nE},translucent:!1});X.ElevationRampType="ElevationRamp";X._materialCache.addMaterial(X.ElevationRampType,{fabric:{type:X.ElevationRampType,uniforms:{image:X.DefaultImageId,minimumHeight:0,maximumHeight:1e4},source:oE},translucent:!1});X.SlopeRampMaterialType="SlopeRamp";X._materialCache.addMaterial(X.SlopeRampMaterialType,{fabric:{type:X.SlopeRampMaterialType,uniforms:{image:X.DefaultImageId},source:hE},translucent:!1});X.AspectRampMaterialType="AspectRamp";X._materialCache.addMaterial(X.AspectRampMaterialType,{fabric:{type:X.AspectRampMaterialType,uniforms:{image:X.DefaultImageId},source:Kw},translucent:!1});X.ElevationBandType="ElevationBand";X._materialCache.addMaterial(X.ElevationBandType,{fabric:{type:X.ElevationBandType,uniforms:{heights:X.DefaultImageId,colors:X.DefaultImageId},source:tE},translucent:!0});X.WaterMaskType="WaterMask";X._materialCache.addMaterial(X.WaterMaskType,{fabric:{type:X.WaterMaskType,source:mE,uniforms:{waterColor:new O(1,1,1,1),landColor:new O(0,0,0,0)}},translucent:!1});const zE={NEVER:z.NEVER,LESS:z.LESS,EQUAL:z.EQUAL,LESS_OR_EQUAL:z.LEQUAL,GREATER:z.GREATER,NOT_EQUAL:z.NOTEQUAL,GREATER_OR_EQUAL:z.GEQUAL,ALWAYS:z.ALWAYS},IE=Object.freeze(zE);function _n(e,t,n){if(!u(e))throw new T("context is required");if(!u(t))throw new T("attributes is required");if(!u(n))throw new T("numberOfInstances is required");if(this._attributes=t,this._numberOfInstances=n,t.length===0)return;const o=PE(t),i=e.floatingPointTexture,a=o===he.FLOAT&&!i,r=ME(t,a),s=NE(r,t,a),f=Math.floor(ge.maximumTextureSize/s),l=Math.min(n,f),d=s*l,m=Math.ceil(n/l),p=1/d,_=p*.5,g=1/m,b=g*.5;this._textureDimensions=new U(d,m),this._textureStep=new W(p,_,g,b),this._pixelDatatype=a?he.UNSIGNED_BYTE:o,this._packFloats=a,this._offsets=r,this._stride=s,this._texture=void 0;const w=4*d*m;this._batchValues=o===he.FLOAT&&!a?new Float32Array(w):new Uint8Array(w),this._batchValuesDirty=!1}Object.defineProperties(_n.prototype,{attributes:{get:function(){return this._attributes}},numberOfInstances:{get:function(){return this._numberOfInstances}}});function PE(e){let t=!1;const n=e.length;for(let o=0;o<n;++o)if(e[o].componentDatatype!==oe.UNSIGNED_BYTE){t=!0;break}return t?he.FLOAT:he.UNSIGNED_BYTE}function Th(e,t){const n=e[t].componentsPerAttribute;return n===2?U:n===3?c:n===4?W:Number}function ME(e,t){const n=new Array(e.length);let o=0;const i=e.length;for(let a=0;a<i;++a){const s=e[a].componentDatatype;n[a]=o,s!==oe.UNSIGNED_BYTE&&t?o+=4:++o}return n}function NE(e,t,n){const o=e.length,i=e[o-1];return t[o-1].componentDatatype!==oe.UNSIGNED_BYTE&&n?i+4:i+1}const si=new W;function DE(e,t,n){let o=W.unpack(e,t,si);const i=W.unpackFloat(o);o=W.unpack(e,t+4,si);const a=W.unpackFloat(o);o=W.unpack(e,t+8,si);const r=W.unpackFloat(o);o=W.unpack(e,t+12,si);const s=W.unpackFloat(o);return W.fromElements(i,a,r,s,n)}function LE(e,t,n){let o=W.packFloat(e.x,si);W.pack(o,t,n),o=W.packFloat(e.y,o),W.pack(o,t,n+4),o=W.packFloat(e.z,o),W.pack(o,t,n+8),o=W.packFloat(e.w,o),W.pack(o,t,n+12)}const Sf=new W;_n.prototype.getBatchedAttribute=function(e,t,n){if(e<0||e>=this._numberOfInstances)throw new T("instanceIndex is out of range.");if(t<0||t>=this._attributes.length)throw new T("attributeIndex is out of range");const o=this._attributes,i=this._offsets[t],r=4*this._stride*e+4*i;let s;this._packFloats&&o[t].componentDatatype!==he.UNSIGNED_BYTE?s=DE(this._batchValues,r,Sf):s=W.unpack(this._batchValues,r,Sf);const f=Th(o,t);return u(f.fromCartesian4)?f.fromCartesian4(s,n):u(f.clone)?f.clone(s,n):s.x};const FE=[void 0,void 0,new U,new c,new W],BE=new W;_n.prototype.setBatchedAttribute=function(e,t,n){if(e<0||e>=this._numberOfInstances)throw new T("instanceIndex is out of range.");if(t<0||t>=this._attributes.length)throw new T("attributeIndex is out of range");if(!u(n))throw new T("value is required.");const o=this._attributes,i=FE[o[t].componentsPerAttribute],a=this.getBatchedAttribute(e,t,i),r=Th(this._attributes,t);if(u(r.equals)?r.equals(a,n):a===n)return;const f=BE;f.x=u(n.x)?n.x:n,f.y=u(n.y)?n.y:0,f.z=u(n.z)?n.z:0,f.w=u(n.w)?n.w:0;const l=this._offsets[t],m=4*this._stride*e+4*l;this._packFloats&&o[t].componentDatatype!==he.UNSIGNED_BYTE?LE(f,this._batchValues,m):W.pack(f,this._batchValues,m),this._batchValuesDirty=!0};function UE(e,t){const n=e._textureDimensions;e._texture=new At({context:t,pixelFormat:me.RGBA,pixelDatatype:e._pixelDatatype,width:n.x,height:n.y,sampler:pn.NEAREST,flipY:!1})}function GE(e){const t=e._textureDimensions;e._texture.copyFrom({source:{width:t.x,height:t.y,arrayBufferView:e._batchValues}})}_n.prototype.update=function(e){u(this._texture)&&!this._batchValuesDirty||this._attributes.length===0||(this._batchValuesDirty=!1,u(this._texture)||UE(this,e.context),GE(this))};_n.prototype.getUniformMapCallback=function(){const e=this;return function(t){return e._attributes.length===0?t:St(t,{batchTexture:function(){return e._texture},batchTextureDimensions:function(){return e._textureDimensions},batchTextureStep:function(){return e._textureStep}})}};function qE(e){const t=e._stride;return e._textureDimensions.y===1?`uniform vec4 batchTextureStep; 
...
`}function kE(e){return e===1?"float":`vec${e}`}function VE(e){return e===1?".x":e===2?".xy":e===3?".xyz":""}function jE(e,t){const o=e._attributes[t],i=o.componentsPerAttribute,a=o.functionName,r=kE(i),s=VE(i),f=e._offsets[t];let l=`${r} ${a}(float batchId) 
{ 
...
`)}function f1(e){let t=Be.replaceMain(e,"czm_non_depth_clamp_main");return t+=`void main() {
    czm_non_depth_clamp_main();
    gl_Position = czm_depthClamp(gl_Position);}
`,t}function l1(e){let t=Be.replaceMain(e,"czm_non_depth_clamp_main");return t+=`void main() {
    czm_non_depth_clamp_main();
    #if defined(LOG_DEPTH)
        czm_writeLogDepth();
    #else
...
`,P1={UNLIT:0,PBR:1},ti=Object.freeze(P1),M1=`in vec3 position3DHigh;
...
`,fr=(e,t,n,o)=>({u_fogIntensity:{type:Jn.FLOAT,value:0},u_maxFog:{type:Jn.FLOAT,value:1},u_fogColor:{type:Jn.VEC3,value:new c(.7,.8,.9)},u_gammaCorrection:{type:Jn.VEC3,value:new c(...e)},u_blackPoint:{type:Jn.VEC3,value:new c(...t)},u_whitePoint:{type:Jn.VEC3,value:new c(...n)},u_saturation:{type:Jn.FLOAT,value:o}});ti.PBR,ti.UNLIT,fr([1,1,1.25],[.02,.02,.02],[.75,.75,.75],1),ti.UNLIT,fr([1.25,1.25,1.23],[0,0,0],[.9,.9,.92],1),ti.UNLIT,fr([1,1,1],[0,0,0],[1,1,1],1),ti.UNLIT,fr([1,1,1.25],[-.1,-.1,-.1],[.9,.9,.9],0);export{qO as $,Oe as A,Q as B,c as C,T as D,Lh as E,ue as F,Ja as G,cs as H,Xe as I,Sn as J,P as K,W as L,M,jf as N,Ee as O,Mt as P,K as Q,Io as R,kA as S,_e as T,LA as U,LO as V,FO as W,IA as X,rA as Y,BO as Z,wA as _,O as a,Ti as a$,GO as a0,UO as a1,jO as a2,HO as a3,VO as a4,is as a5,WO as a6,dn as a7,Ci as a8,kO as a9,Fe as aA,re as aB,nt as aC,ds as aD,Ua as aE,me as aF,ks as aG,At as aH,nn as aI,ht as aJ,Kt as aK,en as aL,tt as aM,Me as aN,Pt as aO,Hn as aP,Be as aQ,mt as aR,IE as aS,Hs as aT,Jt as aU,ln as aV,xo as aW,St as aX,z1 as aY,I1 as aZ,ai as a_,fs as aa,qe as ab,ye as ac,vr as ad,Ae as ae,oe as af,De as ag,Se as ah,Re as ai,zn as aj,xi as ak,J as al,Ce as am,ao as an,io as ao,Et as ap,Lt as aq,no as ar,Te as as,Tt as at,xe as au,Ge as av,zt as aw,Ve as ax,Uo as ay,ii as az,xO as b,It as b0,Ot as b1,z as b2,ge as b3,Gl as b4,he as b5,pn as b6,Le as b7,Ye as b8,No as b9,Ze as ba,Vt as bb,to as bc,An as bd,dt as be,co as bf,In as bg,jt as bh,tl as bi,wt as bj,Cn as bk,we as bl,bu as bm,fl as bn,di as bo,uc as bp,mi as bq,Mr as br,ti as bs,mn as bt,st as bu,Eo as bv,Gt as bw,Jn as bx,sA as by,YO as c,SO as d,mO as e,Ue as f,eO as g,U as h,DO as i,u as j,ne as k,iA as l,A as m,le as n,Ai as o,h as p,et as q,DA as r,ko as s,We as t,ee as u,Ar as v,sm as w,ae as x,on as y,X as z};
